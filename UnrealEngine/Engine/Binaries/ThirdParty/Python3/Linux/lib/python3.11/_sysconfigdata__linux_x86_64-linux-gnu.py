...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/usr/unreal-install/bin',
 'BINLIBDEST': '/usr/unreal-install/lib/python3.11',
 ...
 'CONFIG_ARGS': "'--prefix=/usr/unreal-install' '--enable-ipv6' "
                "'--with-dbmliborder=bdb:gdbm' '--with-system-expat' "
                "'--with-computed-gotos' '--enable-optimizations' "
                "'--with-system-ffi' '--enable-shared' "
                "'--with-openssl=/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl'",
 'CONFINCLUDEDIR': '/usr/unreal-install/include',
 'CONFINCLUDEPY': '/usr/unreal-install/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/usr/build/PythonBuildDeps/Python-3.11.8/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/usr/build/PythonBuildDeps/Python-3.11.8/lcov-report',
 ...
 'DESTDIRS': '/usr/unreal-install /usr/unreal-install/lib '
             '/usr/unreal-install/lib/python3.11 '
             '/usr/unreal-install/lib/python3.11/lib-dynload',
 'DESTLIB': '/usr/unreal-install/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/usr/unreal-install/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/unreal-install/include /usr/unreal-install/include '
                   '/usr/unreal-install/include/python3.11 '
                   '/usr/unreal-install/include/python3.11',
 'INCLUDEDIR': '/usr/unreal-install/include',
 'INCLUDEPY': '/usr/unreal-install/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/usr/unreal-install/lib/python3.11',
 'LIBDIR': '/usr/unreal-install/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/unreal-install/lib/pkgconfig',
 'LIBPL': '/usr/unreal-install/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib '
                 '-l:libssl.a -Wl,--exclude-libs,libssl.a -l:libcrypto.a '
                 '-Wl,--exclude-libs,libcrypto.a  '
                 '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib '
                 '-l:libcrypto.a -Wl,--exclude-libs,libcrypto.a',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/unreal-install/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/usr/unreal-install/share/man',
 'MKDIR_P': '/usr/bin/mkdir -p',
 'MODBUILT_NAMES': '_ssl  _hashlib  atexit  faulthandler  posix  _signal  '
                   ...
                   'xxsubtype',
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib '
            '-l:libssl.a -Wl,--exclude-libs,libssl.a -l:libcrypto.a '
            '-Wl,--exclude-libs,libcrypto.a  '
            '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib '
            '-l:libcrypto.a -Wl,--exclude-libs,libcrypto.a',
 'MODOBJS': 'Modules/_ssl.o  Modules/_hashopenssl.o  Modules/atexitmodule.o  '
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib   '
                            '-lcrypto',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib  '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/include',
 'OPENSSL_LDFLAGS': '-L/usr/build/PythonBuildDeps/ue-prebuilt-libs/openssl/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/usr/build/PythonBuildDeps/Python-3.11.8',
 'SCRIPTDIR': '/usr/unreal-install/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/usr/build/PythonBuildDeps/Python-3.11.8 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/usr/build/PythonBuildDeps/Python-3.11.8 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './usr/unreal-install',
 'WASM_STDLIB': './usr/unreal-install/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/usr/build/PythonBuildDeps/Python-3.11.8',
 'abs_srcdir': '/usr/build/PythonBuildDeps/Python-3.11.8',
 'datarootdir': '/usr/unreal-install/share',
 'exec_prefix': '/usr/unreal-install',
 'prefix': '/usr/unreal-install',
 'srcdir': '.'}

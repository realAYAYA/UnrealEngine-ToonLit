...
#include "OrFilter.generated.h"

UCLASS(meta = (InternalSnapshotFilter))
class LEVELSNAPSHOTFILTERS_API UOrFilter : public UParentFilter
{
	GENERATED_BODY()
public:
...
private:
	...
	EFilterResult::Type EvaluateOrChain(TFunction<EFilterResult::Type(ULevelSnapshotFilter*)> EvaluateFilterCallback) const;	
};

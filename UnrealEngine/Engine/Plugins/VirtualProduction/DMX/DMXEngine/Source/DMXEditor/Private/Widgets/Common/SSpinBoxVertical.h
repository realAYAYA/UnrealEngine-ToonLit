...
public:
	...
	SLATE_BEGIN_ARGS(SSpinBoxVertical<NumericType>)
			...
			[
				...
				[
					...
					[
						...
						.OnTextChanged( this, &SSpinBoxVertical<NumericType>::TextField_OnTextChanged )
						.OnTextCommitted( this, &SSpinBoxVertical<NumericType>::TextField_OnTextCommitted )

...
namespace UE::DMX::Internal
{
	/**************************************************
	 * 
	 * DMX Dev Note: 
	 * 
	 * Implementation and comments are an exact copy of Engine/Source/Runtime/Experimental/Chaos/Public/Framework/TripleBufferedData.h. 
	 * Copied Jan 2024 (~UE5.4), to avoid a dependency on experimental code.
	 * 
	 **************************************************/
	 ...
	 *     // not a requirement.
	 *     TDMXPixelMappingTripleBufferedData<AnimXf> AnimXfTripleBuffer;
	 *     AnimXf* Buffer = nullptr;
	 *
	...
	class TDMXPixelMappingTripleBufferedData
	{
	public:
		TDMXPixelMappingTripleBufferedData()
		 ...
		 * \code
		 * TDMXPixelMappingTripleBufferedData<int> IntBuffer;
		 * ...
	...
	private:
		...
		TDMXPixelMappingTripleBufferedData(TDMXPixelMappingTripleBufferedData&& Other) = delete;
		TDMXPixelMappingTripleBufferedData(const TDMXPixelMappingTripleBufferedData&) = delete;
		TDMXPixelMappingTripleBufferedData& operator=(TDMXPixelMappingTripleBufferedData&&) = delete;
		TDMXPixelMappingTripleBufferedData& operator=(const TDMXPixelMappingTripleBufferedData&) = delete;

...
/**
 * @defgroup read_at zasio::read_at
 *
 ...
 * @code zasio::read_at(d, 42, zasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zasio::read_at(d, 42,
 *     zasio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zasio::read_at(d, 42, zasio::buffer(data, size),
 *     zasio::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 */
...
/*@}*/
/**
 * @defgroup async_read_at zasio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * zasio::async_read_at(d, 42, zasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zasio::async_read_at(d, 42,
 *     zasio::buffer(data, size),
 *     zasio::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.

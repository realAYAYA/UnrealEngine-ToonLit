...
public:
  ...
  zasio::error_code open(implementation_type&,
      const protocol_type&, zasio::error_code& ec)
  {
  ...
  zasio::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  zasio::error_code close(implementation_type&,
      zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  ...
  zasio::error_code cancel(implementation_type&,
      zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  ...
  zasio::error_code listen(implementation_type&,
      int, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  zasio::error_code io_control(implementation_type&,
  ...
  zasio::error_code non_blocking(implementation_type&,
  ...
  zasio::error_code native_non_blocking(implementation_type&,
      bool, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  ...
  zasio::error_code shutdown(implementation_type&,
      socket_base::shutdown_type, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  zasio::error_code bind(implementation_type&,
      const endpoint_type&, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  zasio::error_code set_option(implementation_type&,
      const Option&, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  zasio::error_code get_option(const implementation_type&,
      Option&, zasio::error_code& ec) const
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
      ...
      socket_base::message_flags, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    zasio::post(io_ex, detail::bind_handler(
  ...
  zasio::error_code accept(implementation_type&,
      Socket&, endpoint_type*, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  {
    zasio::error_code ec = zasio::error::operation_not_supported;
    zasio::post(io_ex, detail::bind_handler(handler, ec));
  }

  // Connect the socket to the specified endpoint.
  zasio::error_code connect(implementation_type&,
      const endpoint_type&, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;

...
public:
   ...
   * ...
   * zasio::socket_base::broadcast option(true);
   ...
   * zasio::ip::udp::socket socket(my_context);
   * ...
   * zasio::socket_base::broadcast option;
   ...
   * ...
   * zasio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * zasio::ip::udp::socket socket(my_context);
   * ...
   * zasio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::udp::socket socket(my_context);
   * ...
   * zasio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef zasio::detail::socket_option::integer<
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * zasio::socket_base::reuse_address option(true);
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::socket_base::reuse_address option;
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef zasio::detail::socket_option::linger<
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with zasio::error::connection_aborted.
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
  ...
  typedef zasio::detail::socket_option::boolean<
    ...
    zasio::detail::enable_connection_aborted_option>
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::socket_base::bytes_readable command(true);
...
#else
  typedef zasio::detail::io_control::bytes_readable bytes_readable;
#endif

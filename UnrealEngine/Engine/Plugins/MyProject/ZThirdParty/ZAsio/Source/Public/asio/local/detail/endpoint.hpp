...
public:
  ...
  zasio::detail::socket_addr_type* data()
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const zasio::detail::socket_addr_type* data() const
  {
    return &data_.base;
  }
  ...
  {
    return path_length_
      + offsetof(zasio::detail::sockaddr_un_type, sun_path);
  }
  ...
  {
    return sizeof(zasio::detail::sockaddr_un_type);
  }
...
private:
  ...
  union data_union
  {
    ...
    zasio::detail::sockaddr_un_type local;
  } data_;

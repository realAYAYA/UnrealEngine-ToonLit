...
protected:
  ...
  {
  public:
    explicit auto_addrinfo(zasio::detail::addrinfo_type* ai)
      : ai_(ai)
    {
    }
    ...
    operator zasio::detail::addrinfo_type*()
    {
      return ai_;
    }

  private:
    zasio::detail::addrinfo_type* ai_;
  };
...
private:
  ...
  zasio::detail::scoped_ptr<scheduler_impl> work_scheduler_;

  // Thread used for running the work io_context's run loop.
  zasio::detail::scoped_ptr<zasio::detail::thread> work_thread_;
};

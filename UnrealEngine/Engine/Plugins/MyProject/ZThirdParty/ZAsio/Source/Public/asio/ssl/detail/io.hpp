...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, zasio::error_code& ec)
{
  zasio::error_code io_ec;
  ...
  case engine::want_input_and_retry:
    ...
    {
      core.input_ = zasio::buffer(core.input_buffer_,
...
class io_op
  : public zasio::detail::base_from_cancellation_state<Handler>
{
public:
  io_op(Stream& next_layer, stream_core& core,
      const Operation& op, Handler& handler)
    : zasio::detail::base_from_cancellation_state<Handler>(handler),
  ...
  io_op(const io_op& other)
    : zasio::detail::base_from_cancellation_state<Handler>(other),
  ...
  io_op(io_op&& other)
    : zasio::detail::base_from_cancellation_state<Handler>(
        ASIO_MOVE_CAST(
          zasio::detail::base_from_cancellation_state<Handler>)(
            other)),
      next_layer_(other.next_layer_),
      ...
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.expiry(core_.pending_read_) == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                zasio::buffer(core_.input_buffer_),
        ...
        default:
          ...
          if (start)
          {
            ...
            next_layer_.async_read_some(
                zasio::buffer(core_.input_buffer_, 0),
                ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          {
            ec_ = zasio::error::operation_aborted;
            break;
          }
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : zasio_handler_cont_helpers::is_continuation(this_handler->handler_);
}

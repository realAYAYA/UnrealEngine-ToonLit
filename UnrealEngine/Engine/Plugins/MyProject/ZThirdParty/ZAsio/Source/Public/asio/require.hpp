 ...
 * expression <tt>zasio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>zasio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>zasio::require(zasio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>zasio::require(zasio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>zasio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>zasio::require(std::declval<T>(),
 ...
 * type of the expression <tt>zasio::require(std::declval<T>(),
...
namespace zasio_require_fn {

using zasio::conditional;
using zasio::decay;
using zasio::declval;
using zasio::enable_if;
using zasio::is_applicable_property;
using zasio::traits::require_free;
using zasio::traits::require_member;
using zasio::traits::static_require;
...
static ASIO_CONSTEXPR const zasio_require_fn::impl&
  require = zasio_require_fn::static_instance<>::instance;

} // namespace

typedef zasio_require_fn::impl require_t;
...
struct can_require :
  integral_constant<bool,
    zasio_require_fn::call_traits<
      require_t, T, void(Properties...)>::overload
        != zasio_require_fn::ill_formed>
{
};
...
struct can_require :
  integral_constant<bool,
    zasio_require_fn::call_traits<require_t, T, void(P0, P1, P2)>::overload
      != zasio_require_fn::ill_formed>
{
};
...
struct can_require<T, P0, P1> :
  integral_constant<bool,
    zasio_require_fn::call_traits<require_t, T, void(P0, P1)>::overload
      != zasio_require_fn::ill_formed>
{
};
...
struct can_require<T, P0> :
  integral_constant<bool,
    zasio_require_fn::call_traits<require_t, T, void(P0)>::overload
      != zasio_require_fn::ill_formed>
{
};
...
struct require_result
{
  typedef typename zasio_require_fn::call_traits<

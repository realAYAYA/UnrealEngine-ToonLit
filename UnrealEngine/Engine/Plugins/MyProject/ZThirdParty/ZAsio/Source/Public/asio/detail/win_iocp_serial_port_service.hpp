...
public:
  ...
  ASIO_DECL zasio::error_code open(implementation_type& impl,
      const std::string& device, zasio::error_code& ec);

  // Assign a native handle to a serial port implementation.
  zasio::error_code assign(implementation_type& impl,
      const native_handle_type& handle, zasio::error_code& ec)
  {
  ...
  // Destroy a serial port implementation.
  zasio::error_code close(implementation_type& impl,
      zasio::error_code& ec)
  {
  ...
  zasio::error_code cancel(implementation_type& impl,
      zasio::error_code& ec)
  {
  ...
  zasio::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, zasio::error_code& ec)
  {
  ...
  zasio::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, zasio::error_code& ec) const
  {
  ...
  zasio::error_code send_break(implementation_type&,
      zasio::error_code& ec)
  {
  ...
  size_t write_some(implementation_type& impl,
      const ConstBufferSequence& buffers, zasio::error_code& ec)
  {
  ...
  size_t read_some(implementation_type& impl,
      const MutableBufferSequence& buffers, zasio::error_code& ec)
  {
...
private:
  ...
  typedef zasio::error_code (*store_function_type)(
      const void*, ::DCB&, zasio::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static zasio::error_code store_option(const void* option,
      ::DCB& storage, zasio::error_code& ec)
  {
  ...
  ASIO_DECL zasio::error_code do_set_option(
      ...
      const void* option, zasio::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef zasio::error_code (*load_function_type)(
      void*, const ::DCB&, zasio::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static zasio::error_code load_option(void* option,
      const ::DCB& storage, zasio::error_code& ec)
  {
  ...
  ASIO_DECL zasio::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, zasio::error_code& ec) const;

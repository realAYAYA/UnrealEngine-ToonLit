...
namespace zasio_execution_set_error_fn {

using zasio::decay;
using zasio::declval;
using zasio::enable_if;
using zasio::traits::set_error_free;
using zasio::traits::set_error_member;
...
static ASIO_CONSTEXPR const zasio_execution_set_error_fn::impl&
  set_error = zasio_execution_set_error_fn::static_instance<>::instance;
...
struct can_set_error :
  integral_constant<bool,
    zasio_execution_set_error_fncall_traits<R, void(E)>::overload !=
      zasio_execution_set_error_fnill_formed>
{
};
...
struct is_nothrow_set_error :
  integral_constant<bool,
    zasio_execution_set_error_fncall_traits<R, void(E)>::is_noexcept>
{
};

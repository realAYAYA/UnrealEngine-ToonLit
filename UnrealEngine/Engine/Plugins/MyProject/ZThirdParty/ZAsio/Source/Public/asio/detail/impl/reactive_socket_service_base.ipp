...
zasio::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
    zasio::error_code& ec)
{
  if (is_open(impl))
...
zasio::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    zasio::error_code& ec)
{
  if (!is_open(impl))
...
zasio::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, zasio::error_code& ec)
{
  if (is_open(impl))
  {
...
zasio::error_code reactive_socket_service_base::do_assign(
    ...
    const void* immediate_arg)
{
  ...
  {
    op->ec_ = zasio::error::already_open;
    on_immediate(op, is_continuation, immediate_arg);
  }
}

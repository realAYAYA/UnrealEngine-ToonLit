 ...
 * @code zasio::write(s, zasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code zasio::write(s, zasio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code zasio::write(s, zasio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write zasio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * zasio::async_write(s, zasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.

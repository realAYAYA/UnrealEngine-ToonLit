...
/**
 * The zasio::ip::address_v4 class provides the ability to use and
...
#else
  typedef zasio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  zasio::detail::in4_addr_type addr_;
};
...
template <>
struct hash<zasio::ip::address_v4>
{
  std::size_t operator()(const zasio::ip::address_v4& addr)
    const ASIO_NOEXCEPT
  {

...
public:
  ...
  // Destroy a socket implementation.
  ASIO_DECL zasio::error_code close(
      base_implementation_type& impl, zasio::error_code& ec);
  ...
  ASIO_DECL zasio::error_code cancel(
      base_implementation_type& impl, zasio::error_code& ec);
  ...
  zasio::error_code listen(base_implementation_type& impl,
  ...
  zasio::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, zasio::error_code& ec)
  {
  ...
  zasio::error_code non_blocking(base_implementation_type& impl,
  ...
  zasio::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, zasio::error_code& ec)
  {
  ...
  zasio::error_code wait(base_implementation_type& impl,
      socket_base::wait_type w, zasio::error_code& ec)
  {
    switch (w)
    {
      ...
      socket_base::wait_type w, Handler& handler, const IoExecutor& io_ex)
  {
    bool is_continuation =
      zasio_handler_cont_helpers::is_continuation(handler);

    typename associated_cancellation_slot<Handler>::type slot
      = zasio::get_associated_cancellation_slot(handler);

    // Allocate and construct an operation to wrap the handler.
    typedef reactive_wait_op<Handler, IoExecutor> op;
    typename op::ptr p = { zasio::detail::addressof(handler),
    ...
    case socket_base::wait_error:
      ...
      break;
    default:
      p.p->ec_ = zasio::error::invalid_argument;
  ...
  size_t send(base_implementation_type& impl,
      ...
      socket_base::message_flags flags, zasio::error_code& ec)
  {
    typedef buffer_sequence_adapter<zasio::const_buffer,
  ...
  size_t send(base_implementation_type& impl, const null_buffers&,
      socket_base::message_flags, zasio::error_code& ec)
  {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    start_op(impl, reactor::write_op, p.p, is_continuation, true,
        ((impl.state_ & socket_ops::stream_oriented)
          && buffer_sequence_adapter<zasio::const_buffer,
  ...
  size_t receive(base_implementation_type& impl,
      ...
      socket_base::message_flags flags, zasio::error_code& ec)
  {
    typedef buffer_sequence_adapter<zasio::mutable_buffer,
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    start_op(impl,
        ...
        ((impl.state_ & socket_ops::stream_oriented)
          && buffer_sequence_adapter<zasio::mutable_buffer,
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, zasio::error_code& ec)
  {
    buffer_sequence_adapter<zasio::mutable_buffer,
...
protected:
  ...
  ASIO_DECL zasio::error_code do_open(
      base_implementation_type& impl, int af,
      int type, int protocol, zasio::error_code& ec);

  // Assign a native socket to a socket implementation.
  ASIO_DECL zasio::error_code do_assign(
  ...
  const zasio::error_code success_ec_;
};

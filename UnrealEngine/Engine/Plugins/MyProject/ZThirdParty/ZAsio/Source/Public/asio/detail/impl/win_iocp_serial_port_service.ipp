...
zasio::error_code win_iocp_serial_port_service::open(
...
zasio::error_code win_iocp_serial_port_service::do_set_option(
    win_iocp_serial_port_service::implementation_type& impl,
...
zasio::error_code win_iocp_serial_port_service::do_get_option(

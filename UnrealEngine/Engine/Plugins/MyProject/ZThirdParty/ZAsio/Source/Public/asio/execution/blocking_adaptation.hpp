...
# endif // defined(ASIO_NO_DEPRECATED)
  ...
  {
    return zasio::query(ex, disallowed_t());
  }
...
#endif // !defined(__clang__)
  {
    return zasio::query(ex, allowed_t());
  }
...
public:
  ...
  {
    return zasio::query(executor_, p);
  }
      ...
      is_nothrow_require<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename require_result<const Executor&, Property>::type
        >::type>(0, zasio::require(executor_, p));
  }
      ...
      is_nothrow_prefer<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename prefer_result<const Executor&, Property>::type
        >::type>(0, zasio::prefer(executor_, p));
  }
...
public:
  ...
  struct cleanup
  {
    ~cleanup()
    {
      zasio::detail::mutex::scoped_lock lock(state_->mutex_);

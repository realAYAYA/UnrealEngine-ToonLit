...
public:
   ...
   * zasio::posix::descriptor_base::bytes_readable @n
   * zasio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * zasio::posix::stream_descriptor descriptor(my_context);
   * ...
   * zasio::posix::stream_descriptor::bytes_readable command;
   ...
   * zasio::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(zasio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * zasio::error_code ec;
   * descriptor.wait(zasio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     zasio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   *

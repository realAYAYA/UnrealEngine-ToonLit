 ...
 * expression <tt>zasio::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>zasio::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>zasio::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>zasio::query(std::declval<T>(),
 ...
 * type of the expression <tt>zasio::query(std::declval<T>(),
...
using zasio::traits::query_free;
using zasio::traits::query_member;
using zasio::traits::static_query;
...
static ASIO_CONSTEXPR const zasio_query_fn::impl&
  query = zasio_query_fn::static_instance<>::instance;

} // namespace

typedef zasio_query_fn::impl query_t;

template <typename T, typename Property>
struct can_query :
  integral_constant<bool,
    zasio_query_fn::call_traits<query_t, T, void(Property)>::overload !=
      zasio_query_fn::ill_formed>
{
};
...
struct is_nothrow_query :
  integral_constant<bool,
    zasio_query_fn::call_traits<query_t, T, void(Property)>::is_noexcept>
{
};
...
struct query_result
{
  typedef typename zasio_query_fn::call_traits<

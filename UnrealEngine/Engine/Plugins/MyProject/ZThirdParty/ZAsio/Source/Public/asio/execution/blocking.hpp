...
# endif // defined(ASIO_NO_DEPRECATED)
  ...
  {
    return zasio::query(ex, possibly_t());
  }
...
#endif // !defined(__clang__)
  {
    return zasio::query(ex, always_t());
  }
...
public:
  ...
  {
    return zasio::require(executor_, possibly_t<I>());
  }
  ...
  {
    return zasio::require(executor_, never_t<I>());
  }

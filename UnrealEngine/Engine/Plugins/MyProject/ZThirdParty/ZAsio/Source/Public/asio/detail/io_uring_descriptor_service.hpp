...
public:
  ...
  class implementation_type
    : private zasio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  ASIO_DECL zasio::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  ASIO_DECL zasio::error_code close(implementation_type& impl,
      zasio::error_code& ec);
  ...
  ASIO_DECL zasio::error_code cancel(implementation_type& impl,
      zasio::error_code& ec);

  // Perform an IO control command on the descriptor.
  template <typename IO_Control_Command>
  zasio::error_code io_control(implementation_type& impl,
  ...
  zasio::error_code non_blocking(implementation_type& impl,
  ...
  zasio::error_code native_non_blocking(implementation_type& impl,
      bool mode, zasio::error_code& ec)
  {
  ...
  zasio::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, zasio::error_code& ec)
  {
    switch (w)
    {
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, zasio::error_code& ec)
  {
  ...
  size_t write_some_at(implementation_type& impl, uint64_t,
      const null_buffers& buffers, zasio::error_code& ec)
  {

...
namespace detail
{
  ...
  {
    ec = zasio::error_code();
    zasio::detail::consuming_buffers<const_buffer,
...
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, const ConstBufferSequence& buffers,
    CompletionCondition completion_condition, zasio::error_code& ec)
{
  return detail::write_at_buffer_sequence(d, offset, buffers,
      zasio::buffer_sequence_begin(buffers),
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  zasio::detail::throw_error(ec, "write_at");
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, zasio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, zasio::error_code& ec)
{
...
namespace detail
{
  ...
  //private:
    typedef zasio::detail::consuming_buffers<const_buffer,
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        zasio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  //private:
    zasio::basic_streambuf<Allocator>& streambuf_;
    WriteHandler handler_;
  };

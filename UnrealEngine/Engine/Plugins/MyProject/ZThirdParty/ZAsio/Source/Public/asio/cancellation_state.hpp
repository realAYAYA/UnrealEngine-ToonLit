...
public:
   ...
   * @code zasio::cancellation_type_t filter(
   *     zasio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li zasio::disable_cancellation
   * @li zasio::enable_terminal_cancellation
   * @li zasio::enable_partial_cancellation
   * @li zasio::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code zasio::cancellation_type_t in_filter(
   *     zasio::cancellation_type_t); @endcode
   *
   ...
   * @code zasio::cancellation_type_t out_filter(
   *     zasio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *

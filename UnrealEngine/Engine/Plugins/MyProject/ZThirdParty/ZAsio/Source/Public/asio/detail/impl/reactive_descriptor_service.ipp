...
zasio::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
    const native_handle_type& native_descriptor, zasio::error_code& ec)
{
  if (is_open(impl))
  {
...
zasio::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
    zasio::error_code& ec)
{
  if (is_open(impl))
...
zasio::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    zasio::error_code& ec)
{
  if (!is_open(impl))

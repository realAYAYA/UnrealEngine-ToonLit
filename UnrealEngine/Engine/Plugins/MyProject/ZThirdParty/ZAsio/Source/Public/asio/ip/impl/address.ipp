    ...
    const zasio::ip::address_v4& ipv4_address) ASIO_NOEXCEPT
{
  type_ = ipv4;
  ipv4_address_ = ipv4_address;
  ipv6_address_ = zasio::ip::address_v6();
  return *this;
}
...
{
  type_ = ipv6;
  ipv4_address_ = zasio::ip::address_v4();
  ipv6_address_ = ipv6_address;
  return *this;
}
...
{
  zasio::ip::address_v6 ipv6_address =
    zasio::ip::make_address_v6(str, ec);
  if (!ec)
    return address(ipv6_address);

  zasio::ip::address_v4 ipv4_address =
    zasio::ip::make_address_v4(str, ec);
  if (!ec)
...
zasio::ip::address_v4 address::to_v4() const
{
  if (type_ != ipv4)
  {
    bad_address_cast ex;
...
zasio::ip::address_v6 address::to_v6() const
{
  if (type_ != ipv6)
  {
    bad_address_cast ex;
...
std::string address::to_string(zasio::error_code& ec) const
{
  if (type_ == ipv6)

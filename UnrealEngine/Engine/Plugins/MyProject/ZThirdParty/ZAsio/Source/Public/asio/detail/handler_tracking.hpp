...
public:
  ...
  public:
    ...
    ASIO_DECL void invocation_begin(const zasio::error_code& ec);
    ...
    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const zasio::error_code& ec, int signal_number);

    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const zasio::error_code& ec, const char* arg);
...
# define ASIO_INHERIT_TRACKED_HANDLER \
  : public zasio::detail::handler_tracking::tracked_handler

# define ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public zasio::detail::handler_tracking::tracked_handler

# define ASIO_HANDLER_TRACKING_INIT \
  zasio::detail::handler_tracking::init()

# define ASIO_HANDLER_LOCATION(args) \
  zasio::detail::handler_tracking::location tracked_location args

# define ASIO_HANDLER_CREATION(args) \
  zasio::detail::handler_tracking::creation args

# define ASIO_HANDLER_COMPLETION(args) \
  zasio::detail::handler_tracking::completion tracked_completion args
...
# define ASIO_HANDLER_OPERATION(args) \
  zasio::detail::handler_tracking::operation args

# define ASIO_HANDLER_REACTOR_REGISTRATION(args) \
  zasio::detail::handler_tracking::reactor_registration args

# define ASIO_HANDLER_REACTOR_DEREGISTRATION(args) \
  zasio::detail::handler_tracking::reactor_deregistration args
...
# define ASIO_HANDLER_REACTOR_EVENTS(args) \
  zasio::detail::handler_tracking::reactor_events args

# define ASIO_HANDLER_REACTOR_OPERATION(args) \
  zasio::detail::handler_tracking::reactor_operation args

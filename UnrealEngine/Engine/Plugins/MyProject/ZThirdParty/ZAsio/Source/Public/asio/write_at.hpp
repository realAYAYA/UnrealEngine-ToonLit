...
/**
 * @defgroup write_at zasio::write_at
 *
 ...
 * @code zasio::write_at(d, 42, zasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code zasio::write_at(d, 42, zasio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at zasio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * zasio::async_write_at(d, 42, zasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code zasio::async_write_at(d, 42,

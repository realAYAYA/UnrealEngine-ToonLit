...
/**
 * @par Example
 * @code zasio::awaitable<void> my_coroutine()
 * {
 *   zasio::cancellation_state cs
 *     = co_await zasio::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != zasio::cancellation_type::none)
 *     // ...
 * } @endcode
 */
#if defined(ASIO_HAS_CONSTEXPR) || defined(GENERATING_DOCUMENTATION)
 ...
 * zasio::cancellation_state object <tt>S</tt>, constructed as
 * <tt>S(P)</tt>, into the current coroutine's cancellation state object.
 *
 * @par Example
 * @code zasio::awaitable<void> my_coroutine()
 * {
 *   co_await zasio::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using zasio::co_spawn.
 */
 ...
 * Let <tt>P</tt> be the cancellation slot associated with the current
 * coroutine's @ref co_spawn completion handler. Assigns a new
 * zasio::cancellation_state object <tt>S</tt>, constructed as <tt>S(P,
 ...
 * {
 *   co_await zasio::this_coro::reset_cancellation_state(
 *       zasio::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code zasio::awaitable<void> my_coroutine()
 * {
 *   if (co_await zasio::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code zasio::awaitable<void> my_coroutine()
 * {
 *   co_await zasio::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */

...
public:
   ...
   * @par Example
   * @code
   * zasio::stream_file file(my_context);
   * file.open("/path/to/my/file", zasio::stream_file::read_only);
   * @endcode
   */
   ...
   * zasio::stream_file file(my_context);
   * zasio::error_code ec;
   * file.open("/path/to/my/file", zasio::stream_file::read_only, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  ASIO_SYNC_OP_VOID open(const char* path,
      file_base::flags open_flags, zasio::error_code& ec)
  {
    impl_.get_service().open(impl_.get_implementation(), path, open_flags, ec);
   ...
   * operations will be passed the zasio::error::operation_aborted error.
  ...
  uint64_t size() const
  {
    ...
    zasio::detail::throw_error(ec, "size");
    return s;
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  uint64_t size(zasio::error_code& ec) const
  {
  ...
  void resize(uint64_t n)
  {
    ...
    zasio::detail::throw_error(ec, "resize");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID resize(uint64_t n, zasio::error_code& ec)
  {
    impl_.get_service().resize(impl_.get_implementation(), n, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
  ...
  void sync_all()
  {
    ...
    zasio::detail::throw_error(ec, "sync_all");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID sync_all(zasio::error_code& ec)
  {
    impl_.get_service().sync_all(impl_.get_implementation(), ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
  ...
  void sync_data()
  {
    ...
    zasio::detail::throw_error(ec, "sync_data");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID sync_data(zasio::error_code& ec)
  {
    impl_.get_service().sync_data(impl_.get_implementation(), ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }

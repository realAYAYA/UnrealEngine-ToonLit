...
namespace zasio_execution_submit_fn {

using zasio::declval;
using zasio::enable_if;
using zasio::execution::is_sender_to;
using zasio::traits::submit_free;
using zasio::traits::submit_member;
...
struct impl
{
  ...
  operator()(S&& s, R&& r) const
    ASIO_NOEXCEPT_IF((
      call_traits<S, void(R)>::is_noexcept))
  {
    return zasio::execution::start(
        (new zasio::execution::detail::submit_receiver<S, R>(
  ...
  {
    return zasio::execution::start(
        (new zasio::execution::detail::submit_receiver<
          S&, R&>(s, r))->state_);
  }
...
static ASIO_CONSTEXPR const zasio_execution_submit_fn::impl&
  submit = zasio_execution_submit_fn::static_instance<>::instance;
...
struct can_submit :
  integral_constant<bool,
    zasio_execution_submit_fn::call_traits<S, void(R)>::overload !=
      zasio_execution_submit_fn::ill_formed>
{
};
...
struct is_nothrow_submit :
  integral_constant<bool,
    zasio_execution_submit_fn::call_traits<S, void(R)>::is_noexcept>
{
};
...
{
  typedef typename zasio_execution_submit_fn::call_traits<

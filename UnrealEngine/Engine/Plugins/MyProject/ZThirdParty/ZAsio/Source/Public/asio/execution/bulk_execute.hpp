 ...
 *   guarantee <tt>zasio::query(S, execution::bulk_guarantee)</tt>, and
 ...
 *   progress guarantee <tt>zasio::query(E,
 ...
 *   if <tt>zasio::query(S, execution::bulk_guarantee)</tt> equals
...
namespace zasio_execution_bulk_execute_fn {

using zasio::declval;
using zasio::enable_if;
using zasio::execution::bulk_guarantee_t;
using zasio::execution::detail::bulk_sender;
using zasio::execution::executor_index;
using zasio::execution::is_sender;
using zasio::is_convertible;
using zasio::is_same;
using zasio::remove_cvref;
using zasio::result_of;
using zasio::traits::bulk_execute_free;
using zasio::traits::bulk_execute_member;
...
static ASIO_CONSTEXPR
  const zasio_execution_bulk_execute_fn::impl& bulk_execute =
    zasio_execution_bulk_execute_fn::static_instance<>::instance;
...
struct can_bulk_execute :
  integral_constant<bool,
    zasio_execution_bulk_execute_fn::call_traits<
      S, void(F, N)>::overload !=
        zasio_execution_bulk_execute_fn::ill_formed>
{
};
...
{
  typedef typename zasio_execution_bulk_execute_fn::call_traits<

...
{
  typedef zasio::detail::array<std::size_t, N> order_type;
...
/**
 * See the documentation for zasio::experimental::make_parallel_group for
 * a usage example.
 */
  ...
  struct initiate_async_wait
  {
    ...
    void operator()(Handler&& h, Condition&& c, std::tuple<Ops...>&& ops) const
    {
      detail::parallel_group_launch(
          ...
          ops, zasio::detail::index_sequence_for<Ops...>());
    }
  };
...
public:
   ...
   * operations, it must return a zasio::cancellation_type value other
   * than <tt>zasio::cancellation_type::none</tt>.
   *
   ...
   *
   * @li zasio::experimental::wait_for_all
   * @li zasio::experimental::wait_for_one
   * @li zasio::experimental::wait_for_one_error
   * @li zasio::experimental::wait_for_one_success
   */
  ...
  async_wait(CancellationCondition cancellation_condition,
    ...
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      zasio::async_initiate<CompletionToken, signature>(
          declval<initiate_async_wait>(), token,
          std::move(cancellation_condition), std::move(ops_))))
  {
    return zasio::async_initiate<CompletionToken, signature>(
...
/**
 * For example:
 * @code zasio::experimental::make_parallel_group(
 *    [&](auto token)
 *    {
 *      return in.async_read_some(zasio::buffer(data), token);
 *    },
 *    [&](auto token)
 *    {
 ...
 *    }
 *  ).async_wait(
 *    zasio::experimental::wait_for_all(),
 *    [](
 ...
 *   );
 *
 * zasio::experimental::make_parallel_group(ops).async_wait(
 *     zasio::experimental::wait_for_all(),
 *     [](
 ...
 *   );
 *
 * zasio::experimental::make_parallel_group(
 *     std::allocator_arg_t,
 *     my_allocator,
 *     ops
 *   ).async_wait(

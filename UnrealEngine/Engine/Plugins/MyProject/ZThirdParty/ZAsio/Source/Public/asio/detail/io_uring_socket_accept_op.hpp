...
{
public:
  io_uring_socket_accept_op_base(const zasio::error_code& success_ec,
  ...
  static bool do_perform(io_uring_operation* base, bool after_completion)
  {
    ...
    if (o->ec_ && o->ec_ == zasio::error::would_block)
    {
...
public:
  ...
  io_uring_socket_accept_op(const zasio::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    ptr p = { zasio::detail::addressof(o->handler_), o, o };
    ...
    detail::binder1<Handler, zasio::error_code>
      handler(o->handler_, o->ec_);
    p.h = zasio::detail::addressof(handler.handler_);
    p.reset();
...
public:
  ...
  io_uring_socket_move_accept_op(const zasio::error_code& success_ec,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      zasio::error_code, peer_socket_type>

 ...
 * @code
 * zasio::io_context my_context;
 * zasio::ssl::context ctx(zasio::ssl::context::sslv23);
 * zasio::ssl::stream<asio:ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  void set_verify_callback(VerifyCallback callback)
  {
    ...
    zasio::detail::throw_error(ec, "set_verify_callback");
  }
  ...
  void handshake(handshake_type type)
  {
    zasio::error_code ec;
    handshake(type, ec);
    zasio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID shutdown(zasio::error_code& ec)
  {
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      zasio::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
    ...
    void operator()(ASIO_MOVE_ARG(ShutdownHandler) handler) const
    {
      ...
      zasio::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      zasio::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      zasio::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,

...
public:
  ...
  deadline_timer_service(execution_context& context)
    : execution_context_service_base<
      ...
      scheduler_(zasio::use_service<timer_scheduler>(context))
  {
  ...
  std::size_t cancel(implementation_type& impl, zasio::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
      ec = zasio::error_code();
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, zasio::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, zasio::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, zasio::error_code& ec)
  {
...
private:
  ...
  void do_wait(const Duration& timeout, zasio::error_code& ec)
  {
#if defined(ASIO_WINDOWS_RUNTIME)

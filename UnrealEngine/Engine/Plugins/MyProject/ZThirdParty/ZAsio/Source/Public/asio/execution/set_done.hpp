...
namespace zasio_execution_set_done_fn {

using zasio::decay;
using zasio::declval;
using zasio::enable_if;
using zasio::traits::set_done_free;
using zasio::traits::set_done_member;
...
static ASIO_CONSTEXPR const zasio_execution_set_done_fn::impl&
  set_done = zasio_execution_set_done_fn::static_instance<>::instance;
...
struct can_set_done :
  integral_constant<bool,
    zasio_execution_set_done_fn::call_traits<R>::overload !=
      zasio_execution_set_done_fn::ill_formed>
{
};
...
struct is_nothrow_set_done :
  integral_constant<bool,
    zasio_execution_set_done_fn::call_traits<R>::is_noexcept>
{
};

...
inline void clear(zasio::error_code& ec)
{
  ec.assign(0, ec.category());
}

inline const zasio::error_category& get_system_category()
{
  return zasio::system_category();
}

#if !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

extern ASIO_DECL
const zasio::error_category& get_netdb_category();

extern ASIO_DECL
const zasio::error_category& get_addrinfo_category();

#else // !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const zasio::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const zasio::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern ASIO_DECL
const zasio::error_category& get_misc_category();
...
static const zasio::error_category&
  ...
  = zasio::error::get_netdb_category();
static const zasio::error_category&
  addrinfo_category ASIO_UNUSED_VARIABLE
  = zasio::error::get_addrinfo_category();
static const zasio::error_category&
  misc_category ASIO_UNUSED_VARIABLE
  = zasio::error::get_misc_category();
...
template<> struct is_error_code_enum<zasio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zasio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zasio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zasio::error::misc_errors>
{
  static const bool value = true;
};
...
inline zasio::error_code make_error_code(basic_errors e)
{
  return zasio::error_code(
      static_cast<int>(e), get_system_category());
}

inline zasio::error_code make_error_code(netdb_errors e)
{
  return zasio::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline zasio::error_code make_error_code(addrinfo_errors e)
{
  return zasio::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline zasio::error_code make_error_code(misc_errors e)
{
  return zasio::error_code(

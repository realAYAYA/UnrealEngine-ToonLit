...
private:
  ...
  typedef detail::channel_service<zasio::detail::null_mutex> service_type;
...
public:
  ...
  basic_channel(const executor_type& ex, std::size_t max_buffer_size = 0)
    : service_(&zasio::use_service<service_type>(
  ...
  basic_channel(ExecutionContext& context, std::size_t max_buffer_size = 0,
    ...
    : service_(&zasio::use_service<service_type>(context)),
      impl_(),
   ...
   * @c zasio::experimental::error::channel_cancelled. Outstanding receive
...
private:
  ...
  {
    return zasio::query(t, execution::context);
  }
  ...
  public:
    ...
    {
      zasio::detail::non_const_lvalue<SendHandler> handler2(handler);
  ...
  public:
    ...
    {
      zasio::detail::non_const_lvalue<ReceiveHandler> handler2(handler);

...
extern "C" ASIO_DECL void zasio_signal_handler(int signal_number);
...
public:
  ...
  zasio::error_code add(implementation_type& impl,
  ...
  ASIO_DECL zasio::error_code add(implementation_type& impl,
      int signal_number, signal_set_base::flags_t f,
      zasio::error_code& ec);

  // Remove a signal to a signal_set.
  ASIO_DECL zasio::error_code remove(implementation_type& impl,
      int signal_number, zasio::error_code& ec);

  // Remove all signals from a signal_set.
  ASIO_DECL zasio::error_code clear(implementation_type& impl,
      zasio::error_code& ec);

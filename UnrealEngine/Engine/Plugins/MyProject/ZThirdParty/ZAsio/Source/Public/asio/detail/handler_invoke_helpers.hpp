...
inline void error_if_hook_is_defined(Function& function, Context& context)
{
  ...
  (void)static_cast<zasio::asio_handler_invoke_is_no_longer_used>(
    asio_handler_invoke(function, zasio::detail::addressof(context)));
}

 ...
 * ...
 * zasio::ip::address multicast_address =
 *   zasio::ip::address::from_string("225.0.0.1");
 * zasio::ip::multicast::join_group option(multicast_address);
...
#else
typedef zasio::ip::detail::socket_option::multicast_request<
 ...
 * zasio::ip::address multicast_address =
 *   zasio::ip::address::from_string("225.0.0.1");
 * zasio::ip::multicast::leave_group option(multicast_address);
 * socket.set_option(option);
 * @endcode
 *
 * @par Concepts:
 ...
 * zasio::ip::udp::socket socket(my_context);
 * ...
 * zasio::ip::address_v4 local_interface =
 *   zasio::ip::address_v4::from_string("1.2.3.4");
 * zasio::ip::multicast::outbound_interface option(local_interface);
 * socket.set_option(option);
 * @endcode
 *
 * @par Concepts:
...
#else
typedef zasio::ip::detail::socket_option::network_interface<
  ASIO_OS_DEF(IPPROTO_IP),
 ...
 * zasio::ip::udp::socket socket(my_context);
 * ...
 * zasio::ip::multicast::hops option(4);
 * socket.set_option(option);
 * @endcode
 *
 * @par
 ...
 * zasio::ip::udp::socket socket(my_context);
 * ...
 * zasio::ip::multicast::hops option;
...
#else
typedef zasio::ip::detail::socket_option::multicast_hops<
  ASIO_OS_DEF(IPPROTO_IP),
 ...
 * zasio::ip::udp::socket socket(my_context);
 * ...
 * zasio::ip::multicast::enable_loopback option(true);
 * socket.set_option(option);
 * @endcode
 *
 * @par
 ...
 * zasio::ip::udp::socket socket(my_context);
 * ...
 * zasio::ip::multicast::enable_loopback option;
 * socket.get_option(option);
...
#else
typedef zasio::ip::detail::socket_option::multicast_enable_loopback<
  ASIO_OS_DEF(IPPROTO_IP),

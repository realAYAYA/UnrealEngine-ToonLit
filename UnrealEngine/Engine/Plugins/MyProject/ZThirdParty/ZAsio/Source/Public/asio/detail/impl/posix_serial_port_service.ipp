...
zasio::error_code posix_serial_port_service::open(
...
zasio::error_code posix_serial_port_service::do_set_option(
    posix_serial_port_service::implementation_type& impl,
...
zasio::error_code posix_serial_port_service::do_get_option(

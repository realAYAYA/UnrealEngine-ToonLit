 ...
 * @code zasio::read(s, zasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zasio::read(s, zasio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zasio::read(s, zasio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read zasio::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * zasio::async_read(s, zasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.

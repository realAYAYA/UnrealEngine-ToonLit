...
namespace zasio_execution_start_fn {

using zasio::decay;
using zasio::declval;
using zasio::enable_if;
using zasio::traits::start_free;
using zasio::traits::start_member;
...
static ASIO_CONSTEXPR const zasio_execution_start_fn::impl&
  start = zasio_execution_start_fn::static_instance<>::instance;
...
struct can_start :
  integral_constant<bool,
    zasio_execution_start_fn::call_traits<R>::overload !=
      zasio_execution_start_fn::ill_formed>
{
};
...
struct is_nothrow_start :
  integral_constant<bool,
    zasio_execution_start_fn::call_traits<R>::is_noexcept>
{
};

...
public:
   ...
   */
  explicit strand(zasio::io_context& io_context)
    : service_(zasio::use_service<
        zasio::detail::strand_service>(io_context))
  {
  ...
  zasio::io_context& context() const ASIO_NOEXCEPT
  {
...
#if !defined(ASIO_NO_DEPRECATED)
  /// (Deprecated: Use zasio::dispatch().) Request the strand to invoke
  /// the given handler.
  /**
...
#if !defined(ASIO_NO_DEPRECATED)
  /// (Deprecated: Use zasio::post().) Request the strand to invoke the
...
private:
  ...
  zasio::detail::strand_service& service_;
  mutable zasio::detail::strand_service::implementation_type impl_;
};

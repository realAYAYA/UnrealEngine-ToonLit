...
namespace detail
{
  struct default_connect_condition
  {
    ...
    bool operator()(const zasio::error_code&, const Endpoint&)
    {
      return true;
    }
  };
  ...
  inline typename Protocol::endpoint deref_connect_result(
      Iterator iter, zasio::error_code& ec)
  {
    ...
    static const bool value =
      sizeof(asio_connect_condition_check(
        (declval<legacy_connect_condition_helper<T, Iterator> >())(
          declval<const zasio::error_code>(),
  ...
  inline Iterator call_connect_condition(ConnectCondition& connect_condition,
      const zasio::error_code& ec, Iterator next, Iterator end,
...
namespace detail
{
  ...
  protected:
    ...
    void check_condition(const zasio::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const zasio::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(zasio::error_code ec, int start = 0)
    {
  ...
  //private:
    template <typename Iterator>
    void process(zasio::error_code ec,
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          if (start)
          {
            ec = zasio::error::not_found;
            ASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_connect"));
            zasio::post(socket_.get_executor(),
                detail::bind_handler(
        ...
        ASIO_MOVE_OR_LVALUE(RangeConnectHandler)(handler_)(
            static_cast<const zasio::error_code&>(ec),
  ...
  {
#if defined(ASIO_NO_DEPRECATED)
    zasio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    return asio_handler_allocate_is_no_longer_used();
#else // defined(ASIO_NO_DEPRECATED)
    return zasio_handler_alloc_helpers::allocate(
  ...
  asio_handler_deallocate(void* pointer, std::size_t size,
      range_connect_op<Protocol, Executor, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    zasio_handler_alloc_helpers::deallocate(
  ...
  inline bool asio_handler_is_continuation(
      range_connect_op<Protocol, Executor, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    return zasio_handler_cont_helpers::is_continuation(
  ...
  asio_handler_invoke(Function& function,
      range_connect_op<Protocol, Executor, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    zasio_handler_invoke_helpers::invoke(
        ...
        const ConnectCondition& connect_condition) const
    {
      ...
      range_connect_op<Protocol, Executor, EndpointSequence, ConnectCondition,
        typename decay<RangeConnectHandler>::type>(socket_, endpoints,
          connect_condition, handler2.value)(zasio::error_code(), 1);
    }

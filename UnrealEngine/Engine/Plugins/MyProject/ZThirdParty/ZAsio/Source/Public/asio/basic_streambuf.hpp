 ...
 * zasio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
  ...
  {
    return zasio::buffer(zasio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return zasio::buffer(zasio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("zasio::streambuf too long");

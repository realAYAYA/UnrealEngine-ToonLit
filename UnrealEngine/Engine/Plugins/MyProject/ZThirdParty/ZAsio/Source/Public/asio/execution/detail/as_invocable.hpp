...
struct as_invocable
{
  ...
  explicit as_invocable(Receiver& r) ASIO_NOEXCEPT
    : receiver_(zasio::detail::addressof(r))
  {
  }
...
{
  Receiver* receiver_;
  zasio::detail::shared_ptr<zasio::detail::atomic_count> ref_count_;

  explicit as_invocable(Receiver& r,
      const zasio::detail::shared_ptr<
        zasio::detail::atomic_count>& c) ASIO_NOEXCEPT
    : receiver_(zasio::detail::addressof(r)),
      ref_count_(c)
  {
  }

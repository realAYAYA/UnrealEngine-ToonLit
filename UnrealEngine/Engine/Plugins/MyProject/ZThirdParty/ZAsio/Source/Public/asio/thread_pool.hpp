 ...
 *
 * To submit functions to the thread pool, use the @ref zasio::dispatch,
 ...
 * zasio::thread_pool pool(4);
 *
 * // Submit a function to the pool.
 * zasio::post(pool, my_task);
 *
...
private:
   ...
   * if (zasio::query(ex, zasio::execution::bulk_guarantee)
   *       == zasio::execution::bulk_guarantee.parallel)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * zasio::thread_pool& pool = zasio::query(
...
struct equality_comparable<
    zasio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
...
struct schedule_member<
    const zasio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zasio::thread_pool::basic_executor_type<
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zasio::execution::detail::as_operation<
      zasio::thread_pool::basic_executor_type<Allocator, Bits>,
  ...
  > : zasio::detail::thread_pool_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zasio::thread_pool::basic_executor_type<Allocator,
...
struct query_static_constexpr_member<
    ...
    typename zasio::enable_if<
      zasio::is_convertible<
        Property,
        zasio::execution::bulk_guarantee_t
      >::value
    >::type
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zasio::execution::bulk_guarantee_t::parallel_t result_type;
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zasio::thread_pool& result_type;
};

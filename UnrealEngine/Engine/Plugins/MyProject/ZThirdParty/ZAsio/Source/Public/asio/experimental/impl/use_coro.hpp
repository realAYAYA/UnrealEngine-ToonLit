...
struct async_result<experimental::use_coro_t<Allocator>, R()>
{
  ...
  static auto initiate_impl(zasio::detail::initiation_archetype<R()>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      zasio::any_io_executor, Allocator>;
...
template <typename Allocator, typename R>
struct async_result<
    experimental::use_coro_t<Allocator>, R(zasio::error_code)>
{
  template <typename Initiation, typename... InitArgs>
  static auto initiate_impl(Initiation initiation,
      std::allocator_arg_t, Allocator, InitArgs... args)
      ...
      zasio::associated_executor_t<Initiation>, Allocator>
  {
    co_await deferred_async_operation<
      R(zasio::error_code), Initiation, InitArgs...>(
        deferred_init_tag{}, std::move(initiation), std::move(args)...);
  }

  template <typename... InitArgs>
  static auto initiate_impl(
      zasio::detail::initiation_archetype<R(zasio::error_code)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      zasio::any_io_executor, Allocator>;
    ...
    experimental::use_coro_t<Allocator>, R(std::exception_ptr)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(
      zasio::detail::initiation_archetype<R(std::exception_ptr)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      zasio::any_io_executor, Allocator>;
...
struct async_result<experimental::use_coro_t<Allocator>, R(T)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(zasio::detail::initiation_archetype<R(T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void() noexcept, T,
      zasio::any_io_executor, Allocator>;
...
template <typename Allocator, typename R, typename T>
struct async_result<
    experimental::use_coro_t<Allocator>, R(zasio::error_code, T)>
{
  template <typename Initiation, typename... InitArgs>
  static auto initiate_impl(Initiation initiation,
      std::allocator_arg_t, Allocator, InitArgs... args)
      ...
      zasio::associated_executor_t<Initiation>, Allocator>
  {
    co_return co_await deferred_async_operation<
      R(zasio::error_code, T), Initiation, InitArgs...>(
        deferred_init_tag{}, std::move(initiation), std::move(args)...);
  }

  template <typename... InitArgs>
  static auto initiate_impl(
      zasio::detail::initiation_archetype<
        R(zasio::error_code, T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), T, zasio::any_io_executor, Allocator>;
    ...
    experimental::use_coro_t<Allocator>, R(std::exception_ptr, T)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(
      zasio::detail::initiation_archetype<R(std::exception_ptr, T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), T, zasio::any_io_executor, Allocator>;

...
public:
   ...
   *
   * @throws zasio::system_error Thrown on failure. If the notification
   ...
   * constructor.
   *
   * @throws zasio::service_already_exists Thrown if a service of the
...
#undef ASIO_PRIVATE_MAKE_SERVICE_DEF
   ...
   * given type is already present in the execution_context.
   *
   * @throws zasio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  zasio::detail::service_registry* service_registry_;
};
...
private:
  ...
  friend class zasio::detail::service_registry;
  struct key
  {

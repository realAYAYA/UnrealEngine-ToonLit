...
/// as zasio::basic_stream_socket::async_write_some or
/// zasio::async_write.
...
/// zasio::basic_resolver::async_resolve.
unspecified results;
...
static boost::arg<1>& error
  = zasio::placeholders::detail::placeholder<1>::get();
static boost::arg<2>& bytes_transferred
  = zasio::placeholders::detail::placeholder<2>::get();

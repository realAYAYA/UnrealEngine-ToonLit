...
/**
 * The zasio::ip::address class provides the ability to use either IP
...
public:
  ...
  ASIO_DECL address(
      const zasio::ip::address_v4& ipv4_address) ASIO_NOEXCEPT;

  /// Construct an address from an IPv6 address.
  ASIO_DECL address(
      const zasio::ip::address_v6& ipv6_address) ASIO_NOEXCEPT;
  ...
  ASIO_DECL zasio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  ASIO_DECL zasio::ip::address_v6 to_v6() const;
  ...
  ASIO_DECL std::string to_string(zasio::error_code& ec) const;
  ...
  /// string in dotted decimal form, or from an IPv6 address in hexadecimal
  /// notation.
  static address from_string(const char* str, zasio::error_code& ec);
...
private:
  ...
  zasio::ip::address_v4 ipv4_address_;

  // The underlying IPv6 address.
  zasio::ip::address_v6 ipv6_address_;
};
 ...
 */
ASIO_DECL address make_address(const char* str,
    zasio::error_code& ec) ASIO_NOEXCEPT;
...
template <>
struct hash<zasio::ip::address>
{
  std::size_t operator()(const zasio::ip::address& addr)
    const ASIO_NOEXCEPT
  {
    return addr.is_v4()
      ? std::hash<zasio::ip::address_v4>()(addr.to_v4())
      : std::hash<zasio::ip::address_v6>()(addr.to_v6());
  }
};

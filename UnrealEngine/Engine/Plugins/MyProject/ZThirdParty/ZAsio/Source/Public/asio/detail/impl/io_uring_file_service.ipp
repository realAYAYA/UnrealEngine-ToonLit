...
zasio::error_code io_uring_file_service::open(
...
zasio::error_code io_uring_file_service::resize(
    io_uring_file_service::implementation_type& impl,
...
zasio::error_code io_uring_file_service::sync_all(
    io_uring_file_service::implementation_type& impl,
    zasio::error_code& ec)
{
...
zasio::error_code io_uring_file_service::sync_data(
    io_uring_file_service::implementation_type& impl,
    zasio::error_code& ec)
{

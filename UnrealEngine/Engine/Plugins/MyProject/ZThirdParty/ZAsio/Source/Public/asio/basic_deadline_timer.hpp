 ...
 *
 * Most applications will use the zasio::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * zasio::deadline_timer timer(my_context);
 *
 ...
 * @endcode
 *
 * @li The zasio::basic_deadline_timer::expires_from_now() function
...
template <typename Time,
    typename TimeTraits = zasio::time_traits<Time>,

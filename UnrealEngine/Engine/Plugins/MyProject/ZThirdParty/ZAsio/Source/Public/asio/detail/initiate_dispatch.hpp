...
public:
      ...
      >::type* = 0) const
  {
    ...
    zasio::prefer(ex, execution::allocator(alloc)).execute(
        zasio::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)));
#else // defined(ASIO_NO_DEPRECATED)
    execution::execute(
        zasio::prefer(ex, execution::allocator(alloc)),
        zasio::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)));
      ...
      >::type* = 0) const
  {
    ...
    ex.dispatch(zasio::detail::bind_handler(
...
public:
...
#if defined(ASIO_NO_DEPRECATED)
    zasio::prefer(ex_, execution::allocator(alloc)).execute(
        zasio::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)));
#else // defined(ASIO_NO_DEPRECATED)
    execution::execute(
        zasio::prefer(ex_, execution::allocator(alloc)),
        zasio::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)));
#endif // defined(ASIO_NO_DEPRECATED)
  }
      ...
      >::type* = 0) const
  {
    ...
    ex_.dispatch(zasio::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)), alloc);
  }

...
{
  zasio::detail::scoped_ptr<impl_type> scoped_impl(impl);
  zasio::add_service<impl_type>(*this, scoped_impl.get());
...
io_context::count_type io_context::run(zasio::error_code& ec)
{
  return impl_.run(ec);
}
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::run_one(zasio::error_code& ec)
{
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll(zasio::error_code& ec)
{
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll_one(zasio::error_code& ec)
{
...
io_context::service::service(zasio::io_context& owner)

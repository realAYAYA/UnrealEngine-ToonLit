...
namespace zasio_execution_schedule_fn {

using zasio::decay;
using zasio::declval;
using zasio::enable_if;
using zasio::execution::is_executor;
using zasio::traits::schedule_free;
using zasio::traits::schedule_member;
...
static ASIO_CONSTEXPR const zasio_execution_schedule_fn::impl&
  schedule = zasio_execution_schedule_fn::static_instance<>::instance;
...
struct can_schedule :
  integral_constant<bool,
    zasio_execution_schedule_fn::call_traits<S>::overload !=
      zasio_execution_schedule_fn::ill_formed>
{
};
...
struct is_nothrow_schedule :
  integral_constant<bool,
    zasio_execution_schedule_fn::call_traits<S>::is_noexcept>
{
};

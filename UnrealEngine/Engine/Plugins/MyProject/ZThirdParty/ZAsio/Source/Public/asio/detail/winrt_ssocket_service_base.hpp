...
public:
  ...
  zasio::error_code cancel(base_implementation_type&,
      zasio::error_code& ec)
  {
  ...
  zasio::error_code io_control(base_implementation_type&,
      IO_Control_Command&, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  zasio::error_code non_blocking(base_implementation_type&,
      bool, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  }
  ...
  zasio::error_code native_non_blocking(base_implementation_type&,
      bool, zasio::error_code& ec)
  {
    ec = zasio::error::operation_not_supported;
    return ec;
  ...
  {
    zasio::error_code ec = zasio::error::operation_not_supported;
...
protected:
  ...
  ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, zasio::error_code& ec) const;

  // Helper function to set a socket option.
  ASIO_DECL zasio::error_code do_set_option(
  ...
  ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, zasio::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  ASIO_DECL zasio::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, zasio::error_code& ec);
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const zasio::const_buffer& data,
      socket_base::message_flags flags, zasio::error_code& ec);

  // Helper function to start an asynchronous send.
  ASIO_DECL void start_send_op(base_implementation_type& impl,
      const zasio::const_buffer& data, socket_base::message_flags flags,
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const zasio::mutable_buffer& data,
      socket_base::message_flags flags, zasio::error_code& ec);

  // Helper function to start an asynchronous receive.
  ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const zasio::mutable_buffer& data, socket_base::message_flags flags,

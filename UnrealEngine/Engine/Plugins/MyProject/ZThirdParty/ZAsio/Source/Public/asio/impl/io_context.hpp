...
struct io_context::initiate_post
{
      ...
      io_context* self) const
  {
    ...
    bool is_continuation =
      zasio_handler_cont_helpers::is_continuation(handler2.value);
    ...
    ASIO_MOVE_ARG(Function) f) const
{
  ...
  && !defined(ASIO_NO_EXCEPTIONS)
    try
    {
       ...
       //   && !defined(ASIO_NO_EXCEPTIONS)
      detail::fenced_block b(detail::fenced_block::full);
      zasio_handler_invoke_helpers::invoke(tmp, tmp);
      return;
#if defined(ASIO_HAS_STD_EXCEPTION_PTR) \
  && !defined(ASIO_NO_EXCEPTIONS)
    }
...
#if !defined(ASIO_NO_DEPRECATED)
inline io_context::work::work(zasio::io_context& io_context)
...
inline zasio::io_context& io_context::work::get_io_context()
{
  return static_cast<zasio::io_context&>(io_context_impl_.context());
}
#endif // !defined(ASIO_NO_DEPRECATED)

inline zasio::io_context& io_context::service::get_io_context()
{
  return static_cast<zasio::io_context&>(context());
}

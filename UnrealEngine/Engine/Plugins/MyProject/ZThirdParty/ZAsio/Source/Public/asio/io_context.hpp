 ...
 *
 * @li zasio::ip::tcp::socket
 * @li zasio::ip::tcp::acceptor
 * @li zasio::ip::udp::socket
 * @li zasio::deadline_timer.
 *
 ...
 *
 * To submit functions to the io_context, use the @ref zasio::dispatch,
 * @ref zasio::post or @ref zasio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * zasio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * zasio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * zasio::executor_work_guard<io_context::executor_type>:
 *
 * @code zasio::io_context io_context;
 * zasio::executor_work_guard<zasio::io_context::executor_type>
 *   = zasio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   * without blocking.
   */
  ASIO_DECL count_type run(zasio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  ASIO_DECL count_type run_one(zasio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  ASIO_DECL count_type poll(zasio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  ASIO_DECL count_type poll_one(zasio::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
  ...
  /// (Deprecated: Use zasio::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use zasio::post().) Request the io_context to invoke
  ...
  /// (Deprecated: Use zasio::bind_executor().) Create a new handler that
...
private:
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zasio::require(ex1,
   *     zasio::execution::outstanding_work.tracked); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zasio::require(ex1,
   *     zasio::execution::outstanding_work.untracked); @endcode
   */
  ASIO_CONSTEXPR basic_executor_type<Allocator,
      ASIO_UNSPECIFIED(Bits & ~outstanding_work_tracked)>
...
private:
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * zasio::io_context& ctx = zasio::query(
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (zasio::query(ex, zasio::execution::outstanding_work)
   *       == zasio::execution::outstanding_work.tracked)
   *   ... @endcode
   */
...
public:
   ...
   */
  explicit work(zasio::io_context& io_context);
  ...
  zasio::io_context& get_io_context();
...
protected:
   ...
   */
  ASIO_DECL service(zasio::io_context& owner);
...
class service_base
  : public zasio::io_context::service
{
public:
  static zasio::detail::service_id<Type> id;

  // Constructor.
  service_base(zasio::io_context& io_context)
    : zasio::io_context::service(io_context)
  {
  }
};

template <typename Type>
zasio::detail::service_id<Type> service_base<Type>::id;
...
struct equality_comparable<
    zasio::io_context::basic_executor_type<Allocator, Bits>
  >
{
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zasio::io_context::basic_executor_type<
...
struct require_member<
    zasio::io_context::basic_executor_type<Allocator, Bits>,
    zasio::execution::outstanding_work_t::tracked_t
  > : zasio::detail::io_context_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zasio::io_context::basic_executor_type<
...
struct require_member<
    zasio::io_context::basic_executor_type<Allocator, Bits>,
    zasio::execution::outstanding_work_t::untracked_t
  > : zasio::detail::io_context_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct query_static_constexpr_member<
    ...
    typename zasio::enable_if<
      zasio::is_convertible<
        Property,
        zasio::execution::outstanding_work_t
      >::value
    >::type
  > : zasio::detail::io_context_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zasio::execution::outstanding_work_t result_type;
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zasio::io_context& result_type;
};

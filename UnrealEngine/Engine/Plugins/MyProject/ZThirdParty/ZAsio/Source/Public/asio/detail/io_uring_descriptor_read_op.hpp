...
{
public:
  io_uring_descriptor_read_op_base(const zasio::error_code& success_ec,
...
public:
  ...
  io_uring_descriptor_read_op(const zasio::error_code& success_ec,
      int descriptor, descriptor_ops::state_type state,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::binder2<Handler, zasio::error_code, std::size_t>

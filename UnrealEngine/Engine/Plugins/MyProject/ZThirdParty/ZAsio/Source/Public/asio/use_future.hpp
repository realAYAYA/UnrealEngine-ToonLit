 ...
 * operation, typically using the special value @c zasio::use_future. For
 * example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, zasio::use_future); @endcode
 *
...
public:
   ...
   *     use_future([](zasio::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
...
/// return a future.
/**
 * See the documentation for zasio::use_future_t for a usage example.
 */

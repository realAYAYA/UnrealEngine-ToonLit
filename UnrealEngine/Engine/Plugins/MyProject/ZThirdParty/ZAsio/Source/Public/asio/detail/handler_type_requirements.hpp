...
#define ASIO_LEGACY_COMPLETION_HANDLER_CHECK( \
  ...
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::zero_arg_copyable_handler_test( \
          zasio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef zasio::detail::handler_type_requirements< \
      sizeof( \
        zasio::detail::argbyv( \
          zasio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        zasio::detail::rorlvref< \
          asio_true_handler_type>()(), \
...
#define ASIO_READ_HANDLER_CHECK( \
  ...
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::two_arg_handler_test( \
          zasio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const zasio::error_code*>(0), \
  ...
  typedef zasio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zasio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zasio::detail::lvref<const zasio::error_code>(), \
            zasio::detail::lvref<const std::size_t>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::one_arg_handler_test( \
          zasio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const zasio::error_code*>(0))) == 1, \
...
#define ASIO_MOVE_ACCEPT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(zasio::error_code, socket_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::two_arg_move_handler_test( \
          zasio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const zasio::error_code*>(0), \
  ...
  typedef zasio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zasio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zasio::detail::lvref<const zasio::error_code>(), \
            zasio::detail::rvref<socket_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_RANGE_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(zasio::error_code, endpoint_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::two_arg_handler_test( \
  ...
  typedef zasio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zasio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zasio::detail::lvref<const zasio::error_code>(), \
            zasio::detail::lvref<const endpoint_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_ITERATOR_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(zasio::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::two_arg_handler_test( \
  ...
  typedef zasio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zasio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zasio::detail::lvref<const zasio::error_code>(), \
            zasio::detail::lvref<const iter_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_RESOLVE_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(zasio::error_code, range_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zasio::detail::two_arg_handler_test( \
  ...
  typedef zasio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zasio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zasio::detail::lvref<const zasio::error_code>(), \
            zasio::detail::lvref<const range_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF

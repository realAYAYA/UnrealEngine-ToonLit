...
{
public:
  io_uring_socket_sendto_op_base(const zasio::error_code& success_ec,
...
private:
  ...
  buffer_sequence_adapter<zasio::const_buffer, ConstBufferSequence> bufs_;
  msghdr msghdr_;
};
...
public:
  ...
  io_uring_socket_sendto_op(const zasio::error_code& success_ec,

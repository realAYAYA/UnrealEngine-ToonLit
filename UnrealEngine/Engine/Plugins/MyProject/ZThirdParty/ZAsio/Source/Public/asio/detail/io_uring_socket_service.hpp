...
public:
  ...
  zasio::error_code open(implementation_type& impl,
      const protocol_type& protocol, zasio::error_code& ec)
  {
  ...
  zasio::error_code bind(implementation_type& impl,
      const endpoint_type& endpoint, zasio::error_code& ec)
  {
  ...
  zasio::error_code set_option(implementation_type& impl,
      const Option& option, zasio::error_code& ec)
  {
  ...
  zasio::error_code get_option(const implementation_type& impl,
      Option& option, zasio::error_code& ec) const
  {
  ...
  zasio::error_code shutdown(base_implementation_type& impl,
      socket_base::shutdown_type what, zasio::error_code& ec)
  {
  ...
  zasio::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, zasio::error_code& ec)
  {
    // We cannot accept a socket that is already open.
    if (peer.is_open())
    {
      ec = zasio::error::already_open;
      ASIO_ERROR_LOCATION(ec);
      return ec;
    }
  ...
  zasio::error_code connect(implementation_type& impl,
      const endpoint_type& peer_endpoint, zasio::error_code& ec)
  {

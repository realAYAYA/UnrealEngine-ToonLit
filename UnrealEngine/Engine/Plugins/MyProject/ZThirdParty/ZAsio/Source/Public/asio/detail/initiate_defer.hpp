...
public:
      ...
      >::type* = 0) const
  {
    ...
    zasio::prefer(
        zasio::require(ex, execution::blocking.never),
      ...
      >::type* = 0) const
  {
    ...
    ex.defer(zasio::detail::bind_handler(
...
public:
...
#if defined(ASIO_NO_DEPRECATED)
    zasio::prefer(
        zasio::require(ex_, execution::blocking.never),
        execution::relationship.continuation,
        execution::allocator(alloc)
      ).execute(
        zasio::detail::bind_handler(
      ...
      >::type* = 0) const
  {
    ...
    ex_.defer(zasio::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)), alloc);
  }

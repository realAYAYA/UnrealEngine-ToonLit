...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new zasio::detail::mutex);
...
private:
  ...
  std::vector<zasio::detail::shared_ptr<
        zasio::detail::mutex> > mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)
...
zasio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static zasio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}

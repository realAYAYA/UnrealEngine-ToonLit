 ...
 * expression <tt>zasio::require_concept(E, P)</tt> for some
 ...
 *   with value <tt>true</tt>, <tt>zasio::require_concept(E, P)</tt> is
 *   ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>zasio::require_concept(E, P)</tt> is ill-formed.
 */
 ...
 * <tt>zasio::require_concept(std::declval<T>(),
...
namespace zasio_require_concept_fn {
...
using zasio::traits::require_concept_free;
using zasio::traits::require_concept_member;
using zasio::traits::static_require_concept;

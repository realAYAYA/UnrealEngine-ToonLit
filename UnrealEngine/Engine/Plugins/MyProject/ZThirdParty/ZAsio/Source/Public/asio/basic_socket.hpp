...
public:
    ...
    : impl_(0, ex)
  {
    ...
    zasio::detail::throw_error(ec, "open");
  }
    ...
    : impl_(0, ex)
  {
    ...
    zasio::detail::throw_error(ec, "bind");
  }
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * zasio::error_code ec;
   * socket.open(zasio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  ASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_socket, zasio::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_socket, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * with the zasio::error::operation_aborted error.
   *
   * @throws zasio::system_error Thrown on failure. Note that, even if
   ...
   * will be passed the zasio::error::operation_aborted error. Ownership
   * of the native socket is then transferred to the caller.
   *
   * @throws zasio::system_error Thrown on failure.
   *
   * @note This function is unsupported on Windows versions prior to Windows
   * 8.1, and will fail with zasio::error::operation_not_supported on
   * these platforms.
   */
  ...
  native_handle_type release()
  {
    ...
    zasio::detail::throw_error(ec, "release");
    return s;
  }
  ...
  __declspec(deprecated("This function always fails with "
        ...
        "prior to Windows 8.1."))
#endif
  native_handle_type release(zasio::error_code& ec)
  {
   ...
   * This function causes all outstanding asynchronous connect, send and receive
   * operations to finish immediately, and the handlers for cancelled operations
   * will be passed the zasio::error::operation_aborted error.
   *
   * @throws zasio::system_error Thrown on failure.
   *
   * @note Calls to cancel() will always fail with
   * zasio::error::operation_not_supported when run on Windows XP, Windows
  ...
  bool at_mark() const
  {
    ...
    zasio::detail::throw_error(ec, "at_mark");
    return b;
  }
   ...
   * mark.
   */
  bool at_mark(zasio::error_code& ec) const
  {
  ...
  std::size_t available() const
  {
    ...
    std::size_t s = impl_.get_service().available(
        impl_.get_implementation(), ec);
    zasio::detail::throw_error(ec, "available");
    return s;
  }
   ...
   * error occurs.
   */
  std::size_t available(zasio::error_code& ec) const
  {
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * socket.open(zasio::ip::tcp::v4());
   * socket.bind(zasio::ip::tcp::endpoint(
   *       zasio::ip::tcp::v4(), 12345));
   * @endcode
   */
   ...
   * @code
   * zasio::ip::tcp::socket socket(my_context);
   * zasio::ip::tcp::endpoint endpoint(
   *     zasio::ip::address::from_string("1.2.3.4"), 12345);
  ...
  void connect(const endpoint_type& peer_endpoint)
  {
    ...
    if (!is_open())
    {
      ...
      zasio::detail::throw_error(ec, "connect");
    }
   ...
   * @par Example
   * @code
   * void connect_handler(const zasio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Connect succeeded.
   ...
   * cancellation for the following zasio::cancellation_type values:
   *
  ...
  async_connect(const endpoint_type& peer_endpoint,
    ...
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<ConnectToken, void (zasio::error_code)>(
          declval<initiate_async_connect>(), token,
          peer_endpoint, declval<zasio::error_code&>())))
  {
    zasio::error_code open_ec;
    if (!is_open())
    {
    ...
    return async_initiate<ConnectToken, void (zasio::error_code)>(
   ...
   * zasio::socket_base::broadcast @n
   * zasio::socket_base::do_not_route @n
   * zasio::socket_base::keep_alive @n
   * zasio::socket_base::linger @n
   * zasio::socket_base::receive_buffer_size @n
   * zasio::socket_base::receive_low_watermark @n
   * zasio::socket_base::reuse_address @n
   * zasio::socket_base::send_buffer_size @n
   * zasio::socket_base::send_low_watermark @n
   * zasio::ip::multicast::join_group @n
   * zasio::ip::multicast::leave_group @n
   * zasio::ip::multicast::enable_loopback @n
   * zasio::ip::multicast::outbound_interface @n
   * zasio::ip::multicast::hops @n
   * zasio::ip::tcp::no_delay
   *
   * @par Example
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::ip::tcp::no_delay option(true);
  ...
  void set_option(const SettableSocketOption& option)
  {
    ...
    zasio::detail::throw_error(ec, "set_option");
  }
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::ip::tcp::socket::keep_alive option;
  ...
  void get_option(GettableSocketOption& option) const
  {
    ...
    zasio::detail::throw_error(ec, "get_option");
  }
   ...
   * zasio::socket_base::bytes_readable @n
   * zasio::socket_base::non_blocking_io
   *
   * @par Example
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::ip::tcp::socket::bytes_readable command;
  ...
  void io_control(IoControlCommand& command)
  {
    ...
    zasio::detail::throw_error(ec, "io_control");
  }
   ...
   * zasio::error::would_block if they are unable to perform the requested
   * operation immediately. If @c false, synchronous operations will block
   * until complete.
   *
   * @note The non-blocking mode has no effect on the behaviour of asynchronous
   * operations. Asynchronous operations will never fail with the error
   * zasio::error::would_block.
   */
  ...
  void non_blocking(bool mode)
  {
    ...
    zasio::detail::throw_error(ec, "non_blocking");
  }
   ...
   * direct system calls may fail with zasio::error::would_block (or the
   ...
   *   void operator()(zasio::error_code ec, std::size_t)
   *   {
   ...
   *         ec = zasio::error_code(n < 0 ? errno : 0,
   ...
   * mode and direct system calls may fail with zasio::error::would_block
   * (or the equivalent system error).
   *
   * @throws zasio::system_error Thrown on failure. If the @c mode is
   * @c false, but the current value of @c non_blocking() is @c true, this
   * function fails with zasio::error::invalid_argument, as the
  ...
  void native_non_blocking(bool mode)
  {
    ...
    zasio::detail::throw_error(ec, "native_non_blocking");
  }
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::ip::tcp::endpoint endpoint = socket.local_endpoint();
   * @endcode
   */
  endpoint_type local_endpoint() const
  {
    ...
    endpoint_type ep = impl_.get_service().local_endpoint(
        impl_.get_implementation(), ec);
    zasio::detail::throw_error(ec, "local_endpoint");
    return ep;
  }
   ...
   * ...
   * zasio::error_code ec;
   * zasio::ip::tcp::endpoint endpoint = socket.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  endpoint_type local_endpoint(zasio::error_code& ec) const
  {
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * zasio::ip::tcp::endpoint endpoint = socket.remote_endpoint();
   * @endcode
   */
  endpoint_type remote_endpoint() const
  {
    ...
    endpoint_type ep = impl_.get_service().remote_endpoint(
        impl_.get_implementation(), ec);
    zasio::detail::throw_error(ec, "remote_endpoint");
    return ep;
  }
   ...
   * ...
   * zasio::error_code ec;
   * zasio::ip::tcp::endpoint endpoint = socket.remote_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  endpoint_type remote_endpoint(zasio::error_code& ec) const
  {
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * socket.shutdown(zasio::ip::tcp::socket::shutdown_send);
   * @endcode
   */
  void shutdown(shutdown_type what)
  {
    ...
    zasio::detail::throw_error(ec, "shutdown");
  }
   ...
   * ...
   * zasio::error_code ec;
   * socket.shutdown(zasio::ip::tcp::socket::shutdown_send, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * socket.wait(zasio::ip::tcp::socket::wait_read);
   * @endcode
   */
   ...
   * ...
   * zasio::error_code ec;
   * socket.wait(zasio::ip::tcp::socket::wait_read, ec);
   * @endcode
   */
  ASIO_SYNC_OP_VOID wait(wait_type w, zasio::error_code& ec)
  {
    impl_.get_service().wait(impl_.get_implementation(), w, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * @par Example
   * @code
   * void wait_handler(const zasio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Wait succeeded.
   ...
   * zasio::ip::tcp::socket socket(my_context);
   * ...
   * socket.async_wait(zasio::ip::tcp::socket::wait_read, wait_handler);
   * @endcode
   *
   * @par Per-Operation Cancellation
   * On POSIX or Windows operating systems, this asynchronous operation supports
...
private:
  ...
  public:
    ...
    void operator()(ASIO_MOVE_ARG(ConnectHandler) handler,
        ...
        const zasio::error_code& open_ec) const
    {
      ...
      if (open_ec)
      {
          zasio::post(self_->impl_.get_executor(),
              zasio::detail::bind_handler(

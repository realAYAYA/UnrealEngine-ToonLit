 ...
 * expression <tt>zasio::prefer(E, P0, Pn...)</tt> for some subexpressions
 ...
 *   <tt>zasio::prefer(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>zasio::prefer(zasio::prefer(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>zasio::prefer(zasio::prefer(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>zasio::prefer(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>zasio::prefer(std::declval<T>(),
 ...
 * type of the expression <tt>zasio::prefer(std::declval<T>(),
...
using zasio::traits::prefer_free;
using zasio::traits::prefer_member;
...
static ASIO_CONSTEXPR const zasio_prefer_fn::impl&
  prefer = zasio_prefer_fn::static_instance<>::instance;

} // namespace

typedef zasio_prefer_fn::impl prefer_t;
...
struct can_prefer :
  integral_constant<bool,
    zasio_prefer_fn::call_traits<
      prefer_t, T, void(Properties...)>::overload
        != zasio_prefer_fn::ill_formed>
{
};
...
struct prefer_result
{
  typedef typename zasio_prefer_fn::call_traits<

...
namespace zasio_execution_set_value_fn {

using zasio::decay;
using zasio::declval;
using zasio::enable_if;
using zasio::traits::set_value_free;
using zasio::traits::set_value_member;
...
static ASIO_CONSTEXPR const zasio_execution_set_value_fn::impl&
  set_value = zasio_execution_set_value_fn::static_instance<>::instance;
...
struct can_set_value :
  integral_constant<bool,
    zasio_execution_set_value_fn::call_traits<R, void(Vs...)>::overload !=
      zasio_execution_set_value_fn::ill_formed>
{
};
...
struct is_nothrow_set_value :
  integral_constant<bool,
    zasio_execution_set_value_fn::call_traits<R, void(Vs...)>::is_noexcept>
{
};
...
struct can_set_value<R> :
  integral_constant<bool,
    zasio_execution_set_value_fn::call_traits<R, void()>::overload !=
      zasio_execution_set_value_fn::ill_formed>
{
};
...
struct is_nothrow_set_value<R> :
  integral_constant<bool,
    zasio_execution_set_value_fn::call_traits<R, void()>::is_noexcept>
{
};
...
#define ASIO_PRIVATE_SET_VALUE_TRAITS_DEF(n) \
  ...
  struct can_set_value<R, ASIO_VARIADIC_TARGS(n)> : \
    integral_constant<bool, \
      zasio_execution_set_value_fn::call_traits<R, \

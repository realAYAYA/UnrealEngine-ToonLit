...
/**
 * @defgroup connect zasio::connect
 *
 ...
 *
 * @throws zasio::system_error Thrown on failure. If the sequence is
 * empty, the associated @c error_code is zasio::error::not_found.
 ...
 * zasio::connect(s, r.resolve(q)); @endcode
 */
 ...
 * empty, set to zasio::error::not_found. Otherwise, contains the error
 ...
 * tcp::socket s(my_context);
 * zasio::error_code ec;
 * zasio::connect(s, r.resolve(q), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
...
template <typename Protocol, typename Executor, typename EndpointSequence>
typename Protocol::endpoint connect(basic_socket<Protocol, Executor>& s,
    const EndpointSequence& endpoints, zasio::error_code& ec,
    typename constraint<is_endpoint_sequence<
        EndpointSequence>::value>::type = 0);
 ...
 * iterator types such as @c zasio::ip::tcp::resolver::iterator.
 */
...
Iterator connect(basic_socket<Protocol, Executor>& s,
    Iterator begin, zasio::error_code& ec,
    typename constraint<!is_endpoint_sequence<Iterator>::value>::type = 0);
 ...
 * tcp::socket s(my_context);
 * zasio::connect(s, e.begin(), e.end()); @endcode
 */
template <typename Protocol, typename Executor, typename Iterator>
Iterator connect(basic_socket<Protocol, Executor>& s,
 ...
 * tcp::socket s(my_context);
 * zasio::error_code ec;
 * zasio::connect(s, e.begin(), e.end(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
...
template <typename Protocol, typename Executor, typename Iterator>
Iterator connect(basic_socket<Protocol, Executor>& s,
    Iterator begin, Iterator end, zasio::error_code& ec);
 ...
 *   }
 * }; @endcode
 * It would be used with the zasio::connect function as follows:
 * @code tcp::resolver r(my_context);
 * tcp::resolver::query q("host", "service");
 * tcp::socket s(my_context);
 * tcp::endpoint e = zasio::connect(s,
...
template <typename Protocol, typename Executor,
    typename Iterator, typename ConnectCondition>
Iterator connect(basic_socket<Protocol, Executor>& s, Iterator begin,
    ConnectCondition connect_condition, zasio::error_code& ec,
    typename constraint<!is_endpoint_sequence<Iterator>::value>::type = 0);
#endif // !defined(ASIO_NO_DEPRECATED)
 ...
 * tcp::resolver::results_type e = r.resolve(q);
 * tcp::socket s(my_context);
 * tcp::resolver::results_type::iterator i = zasio::connect(
...
/**
 * @defgroup async_connect zasio::async_connect
 *
 ...
 *   // zasio::error::not_found. Otherwise, contains the
 ...
 * @code void(zasio::error_code, typename Protocol::endpoint) @endcode
 *
 * @par Example
 * @code tcp::resolver r(my_context);
 * tcp::resolver::query q("host", "service");
 ...
 *   if (!ec)
 *   {
 *     zasio::async_connect(s, results, connect_handler);
 *   }
 * }
 *
 * // ...
...
ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(RangeConnectToken,
    void (zasio::error_code, typename Protocol::endpoint))
 ...
 *
 * @par Completion Signature
 * @code void(zasio::error_code, Iterator) @endcode
 *
 * @note This overload assumes that a default constructed object of type @c
 * Iterator represents the end of the sequence. This is a valid assumption for
 * iterator types such as @c zasio::ip::tcp::resolver::iterator.
...
ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(IteratorConnectToken,
    void (zasio::error_code, Iterator))

...
public:
  ...
  // The query type.
  typedef zasio::ip::basic_resolver_query<Protocol> query_type;

  // The results type.
  typedef zasio::ip::basic_resolver_results<Protocol> results_type;
  ...
  results_type resolve(implementation_type&,
      const query_type& query, zasio::error_code& ec)
  {
    try
    {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    zasio::post(io_ex, detail::bind_handler(handler, ec, results));
  }

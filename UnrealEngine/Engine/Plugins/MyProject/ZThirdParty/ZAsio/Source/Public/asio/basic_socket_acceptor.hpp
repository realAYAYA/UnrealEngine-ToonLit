 ...
 * @code
 * zasio::ip::tcp::acceptor acceptor(my_context);
 * zasio::ip::tcp::endpoint endpoint(zasio::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(zasio::ip::tcp::acceptor::reuse_address(true));
...
public:
    ...
    : impl_(0, ex)
  {
    ...
    zasio::detail::throw_error(ec, "listen");
  }
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * zasio::error_code ec;
   * acceptor.open(zasio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  ASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_acceptor, zasio::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_acceptor, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @code
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * zasio::ip::tcp::endpoint endpoint(zasio::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * zasio::error_code ec;
   * acceptor.listen(zasio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  ASIO_SYNC_OP_VOID listen(int backlog, zasio::error_code& ec)
  {
    impl_.get_service().listen(impl_.get_implementation(), backlog, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the zasio::error::operation_aborted error. Ownership of the
   ...
   * zasio::socket_base::reuse_address
   * zasio::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::acceptor::reuse_address option(true);
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::acceptor::reuse_address option;
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with zasio::error::would_block if they are unable to perform the
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * zasio::error_code ec;
   * zasio::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * acceptor.wait(zasio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * zasio::error_code ec;
   * acceptor.wait(zasio::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     zasio::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   *
      ...
      >::type = 0)
  {
    ...
    zasio::detail::throw_error(ec, "accept");
  }
  ...
  ASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1, Executor1>& peer, zasio::error_code& ec,
      typename constraint<
        is_convertible<Protocol, Protocol1>::value
      >::type = 0)
  {
   ...
   * @par Example
   * @code
   * void accept_handler(const zasio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  async_accept(basic_socket<Protocol1, Executor1>& peer,
      ...
      >::type = 0)
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<AcceptToken, void (zasio::error_code)>(
          declval<initiate_async_accept>(), token,
          &peer, static_cast<endpoint_type*>(0))))
  {
    return async_initiate<AcceptToken, void (zasio::error_code)>(
  ...
  ASIO_SYNC_OP_VOID accept(basic_socket<protocol_type, Executor1>& peer,
      endpoint_type& peer_endpoint, zasio::error_code& ec)
  {
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  async_accept(
    ...
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<MoveAcceptToken,
        void (zasio::error_code, typename Protocol::socket::template
          rebind_executor<executor_type>::other)>(
   ...
   * zasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zasio::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const Executor1& ex, zasio::error_code& ec,
      typename constraint<
        is_executor<Executor1>::value
          || execution::is_executor<Executor1>::value
      >::type = 0)
  ...
  typename Protocol::socket::template rebind_executor<
      typename ExecutionContext::executor_type>::other
  accept(ExecutionContext& context, zasio::error_code& ec,
      typename constraint<
        is_convertible<ExecutionContext&, execution_context&>::value
      >::type = 0)
  {
   ...
   * ...
   * zasio::ip::tcp::endpoint endpoint;
   * zasio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
   ...
   * ...
   * zasio::ip::tcp::endpoint endpoint;
   * zasio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(endpoint_type& peer_endpoint, zasio::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(),

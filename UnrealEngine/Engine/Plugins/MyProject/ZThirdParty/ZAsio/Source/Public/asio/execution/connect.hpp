...
namespace zasio_execution_connect_fn {

using zasio::conditional;
using zasio::declval;
using zasio::enable_if;
using zasio::execution::detail::as_invocable;
using zasio::execution::detail::as_operation;
using zasio::execution::detail::is_as_receiver;
using zasio::execution::is_executor_of;
using zasio::execution::is_operation_state;
using zasio::execution::is_receiver;
using zasio::execution::is_sender;
using zasio::false_type;
using zasio::remove_cvref;
using zasio::traits::connect_free;
using zasio::traits::connect_member;
...
static ASIO_CONSTEXPR const zasio_execution_connect_fn::impl&
  connect = zasio_execution_connect_fn::static_instance<>::instance;
...
struct can_connect :
  integral_constant<bool,
    zasio_execution_connect_fn::call_traits<S, void(R)>::overload !=
      zasio_execution_connect_fn::ill_formed>
{
};
...
struct is_nothrow_connect :
  integral_constant<bool,
    zasio_execution_connect_fn::call_traits<S, void(R)>::is_noexcept>
{
};
...
struct connect_result
{
  typedef typename zasio_execution_connect_fn::call_traits<

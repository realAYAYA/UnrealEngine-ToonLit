...
zasio::error_code io_uring_descriptor_service::assign(
    io_uring_descriptor_service::implementation_type& impl,
...
zasio::error_code io_uring_descriptor_service::close(
    io_uring_descriptor_service::implementation_type& impl,
    zasio::error_code& ec)
{
  if (is_open(impl))
...
zasio::error_code io_uring_descriptor_service::cancel(
    io_uring_descriptor_service::implementation_type& impl,
    zasio::error_code& ec)
{
  if (!is_open(impl))

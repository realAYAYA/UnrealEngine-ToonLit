...
protected:
  ...
  friend class zasio::detail::op_queue_access;
...
public:
  ...
  void post(Function& function, Handler& handler)
  {
    ...
    zasio::prefer(
        zasio::require(executor_, execution::blocking.never),
...
public:
  ...
  void immediate(Function& function, Handler& handler, ...)
  {
    ...
    (zasio::detail::initiate_dispatch_with_executor<immediate_ex_type>(
  ...
  void immediate(Function& function, Handler&,
      ...
      >::type*)
  {
    (zasio::detail::initiate_post_with_executor<
        typename base1_type::executor_type>(

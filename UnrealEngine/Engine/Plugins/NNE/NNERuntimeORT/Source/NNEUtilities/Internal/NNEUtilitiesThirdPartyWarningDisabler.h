...
/*
Many third party headers require some care when importing. NNE third party includes should be wrapped like this:
...
#define NNE_THIRD_PARTY_INCLUDES_START THIRD_PARTY_INCLUDES_START \
...
#define NNE_THIRD_PARTY_INCLUDES_START THIRD_PARTY_INCLUDES_START UE_PUSH_MACRO("check") UE_PUSH_MACRO("TEXT")
#endif //PLATFORM_NNE_MICROSOFT

#define NNE_THIRD_PARTY_INCLUDES_END THIRD_PARTY_INCLUDES_END UE_POP_MACRO("check") UE_POP_MACRO("TEXT")

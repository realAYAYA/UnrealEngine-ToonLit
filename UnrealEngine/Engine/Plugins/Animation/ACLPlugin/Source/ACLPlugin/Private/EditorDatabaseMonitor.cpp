...
{
	static FTSTicker::FDelegateHandle MonitorTickerHandle;
	...
	void RegisterMonitor()
	{
		...
		MonitorTickerHandle = FTSTicker::GetCoreTicker().AddTicker(TEXT("ACLEditorDatabaseMonitor"), TickerDelay, MonitorTicker);
	}

...
// Definition
const Vector<String<char> > guiControlNames = {
    "GA", "GB", "GC", "GD", "GE", "GF", "GG", "GH", "GI"
};
const Vector<String<char> > rawControlNames = {

...
#define AJA_NTV2_SDK_VERSION_MINOR		2			///< @brief The SDK minor version number, an unsigned decimal integer.
#define AJA_NTV2_SDK_VERSION_POINT		0			///< @brief The SDK "point" release version, an unsigned decimal integer.
#define AJA_NTV2_SDK_BUILD_NUMBER		3			///< @brief The SDK build number, an unsigned decimal integer.
#define AJA_NTV2_SDK_BUILD_DATETIME		"Wed Feb 02 21:58:01 UTC 2022"		///< @brief The date and time the SDK was built, in this format: "MM/DD/YYYY +8:hh:mm:ss"
...
//	NTV2_BITFILE_KONAIP_2RX_1SFP_J2K= 48,	//	Never built or shipped
	...
	NTV2_BITFILE_SOJI_OE1_MAIN		= 81,
	NTV2_BITFILE_SOJI_OE2_MAIN		= 82,
	NTV2_BITFILE_SOJI_OE3_MAIN		= 83,
	NTV2_BITFILE_SOJI_OE4_MAIN		= 84,

...
#define WMFMEDIA_SUPPORTED_PLATFORM (PLATFORM_WINDOWS && !UE_SERVER)
	...
	// A private GUID used to add a wrapped format GUID to an IMFMediaType.
	const GUID UE_WMF_PrivateFormatGUID = { 0x630d3c34, 0xefac, 0x42f0, {0xa9, 0x6f, 0x6e, 0xa2, 0x6f, 0xd4, 0x16, 0x6}};

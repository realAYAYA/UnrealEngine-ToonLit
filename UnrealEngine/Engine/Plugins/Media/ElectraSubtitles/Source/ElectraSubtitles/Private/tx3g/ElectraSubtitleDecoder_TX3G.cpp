...
bool FElectraSubtitleDecoderTX3G::InitializeStreamWithCSD(const TArray<uint8>& InCSD, const Electra::FParamDict& InAdditionalInfo)
{
	...
	Width = (int32) InAdditionalInfo.GetValue(ElectraSubtitleDecoderTX3GUtils::OptionKeys::Width).SafeGetInt64(0);
	Height = (int32) InAdditionalInfo.GetValue(ElectraSubtitleDecoderTX3GUtils::OptionKeys::Height).SafeGetInt64(0);
	TranslationX = (int32) InAdditionalInfo.GetValue(ElectraSubtitleDecoderTX3GUtils::OptionKeys::OffsetX).SafeGetInt64(0);
	TranslationY = (int32) InAdditionalInfo.GetValue(ElectraSubtitleDecoderTX3GUtils::OptionKeys::OffsetY).SafeGetInt64(0);
	Timescale = (uint32) InAdditionalInfo.GetValue(ElectraSubtitleDecoderTX3GUtils::OptionKeys::Timescale).SafeGetInt64(0);

...
class IElectraH264VideoDecoderAndroidJava
{
public:

	static TSharedPtr<IElectraH264VideoDecoderAndroidJava, ESPMode::ThreadSafe> Create();

	virtual ~IElectraH264VideoDecoderAndroidJava() = default;
	...
	struct FCreateParameters
	{
		...
		const ElectraDecodersUtil::MPEG::FAVCDecoderConfigurationRecord* CodecData = nullptr;

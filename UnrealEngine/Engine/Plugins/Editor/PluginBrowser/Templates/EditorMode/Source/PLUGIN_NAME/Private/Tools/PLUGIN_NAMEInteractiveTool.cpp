...
#include "PLUGIN_NAMEInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UPLUGIN_NAMEInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UPLUGIN_NAMEInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UPLUGIN_NAMEInteractiveTool* NewTool = NewObject<UPLUGIN_NAMEInteractiveTool>(SceneState.ToolManager);
...
UPLUGIN_NAMEInteractiveToolProperties::UPLUGIN_NAMEInteractiveToolProperties()
{
...
void UPLUGIN_NAMEInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UPLUGIN_NAMEInteractiveTool::Setup()
{
	...
	Properties = NewObject<UPLUGIN_NAMEInteractiveToolProperties>(this, "Measurement");
...
void UPLUGIN_NAMEInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UPLUGIN_NAMEInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UPLUGIN_NAMEInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UPLUGIN_NAMEInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UPLUGIN_NAMEInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UPLUGIN_NAMEInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UPLUGIN_NAMEInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UPLUGIN_NAMEInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UPLUGIN_NAMEInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

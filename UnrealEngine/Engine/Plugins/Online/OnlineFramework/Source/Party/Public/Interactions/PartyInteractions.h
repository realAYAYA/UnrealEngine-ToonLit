...
DECLARE_SOCIAL_INTERACTION_EXPORT(PARTY_API, RequestToJoinParty);
DECLARE_SOCIAL_INTERACTION_EXPORT(PARTY_API, AcceptJoinRequest);
DECLARE_SOCIAL_INTERACTION_EXPORT(PARTY_API, DismissJoinRequest);

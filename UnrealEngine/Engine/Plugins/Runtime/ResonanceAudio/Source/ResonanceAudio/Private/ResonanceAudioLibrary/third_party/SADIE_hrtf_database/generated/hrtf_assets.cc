...
namespace sadie {
	...
	{
		return GetByteArray(filename, out_file_size);
	}


	const unsigned char* GetByteArray(const std::string& filename, size_t& out_file_size)
	{
		// Beginning of file injection:
		static const std::string hrir_order_1_file_name("WAV/Subject_002/SH/sh_hrir_order_1.wav");
		static const size_t hrir_order_1_file_size = 0x82C;
		static const unsigned char hrir_order_1_file[0x82C] =
		 {0x52, 0x49, 0x46, 0x46, 0x24, 0x8, 0x0, 0x0, 0x57, 0x41, 0x56, 0x45, 0x66,
		  ...
		  static const std::string hrir_order_2_file_name("WAV/Subject_002/SH/sh_hrir_order_2.wav");
		  static const size_t hrir_order_2_file_size = 0x122C;
		  static const unsigned char hrir_order_2_file[0x122C] =
		  ...
		  static const std::string hrir_order_3_file_name("WAV/Subject_002/SH/sh_hrir_order_3.wav");
		  static const size_t hrir_order_3_file_size = 0x2020C;
		  static const unsigned char hrir_order_3_file[0x2020C] =
		...
		// end of file injection
		  ...
		  if (filename.compare(hrir_order_1_file_name) == 0)
		  {
			  out_file_size = hrir_order_1_file_size;
			  return hrir_order_1_file;
		  }
		  else if (filename.compare(hrir_order_2_file_name) == 0)
		  {
			  out_file_size = hrir_order_2_file_size;
			  return hrir_order_2_file;
		  }
		  else if (filename.compare(hrir_order_3_file_name) == 0)
		  {
			  out_file_size = hrir_order_3_file_size;
			  return hrir_order_3_file;
		  }

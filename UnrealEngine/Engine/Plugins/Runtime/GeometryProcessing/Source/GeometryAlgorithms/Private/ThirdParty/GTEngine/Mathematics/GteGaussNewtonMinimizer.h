...
namespace gte
{
    ...
    public:
        ...
        // arguments.  The unit-test code for the first GaussNewtonMinimizer
        ...
        //   GaussNewtonMinimizer<Real> minimizer(
        //       numPDimensions, numFDimensions,
        //       (GaussNewtonMinimizer<Real>::FFunction const&) myFFunction,
        //       (GaussNewtonMinimizer<Real>::JFunction const&) myJFunction);

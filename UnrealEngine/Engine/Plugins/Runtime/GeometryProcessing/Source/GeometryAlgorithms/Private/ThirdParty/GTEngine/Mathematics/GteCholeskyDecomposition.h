...
namespace gte
{
    ...
    public:
        ...
        bool Factor(GMatrix<Real>& A)
        {
            ...
            {
                LogError("Matrix must be square in CholeskyDecomposition::Factor.");
                return false;
            }
        }
        ...
        void SolveLower(GMatrix<Real> const& L, GVector<Real>& Y)
        {
            ...
            {
                LogError("Invalid size in CholeskyDecomposition::SolveLower.");
                Y.MakeZero();
            }
        }
    ...
    public:
        ...
        {
            LogAssert(blockSize > 0 && numBlocks > 0, "Invalid size in BlockCholeskyDecomposition constructor.");
        }

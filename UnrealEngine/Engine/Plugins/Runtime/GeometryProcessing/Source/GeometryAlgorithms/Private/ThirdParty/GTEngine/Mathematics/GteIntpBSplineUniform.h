...
namespace gte
{
    ...
    public:
        ...
        inline int GetNumControls(int dim) const { return mNumControls[dim]; }
        inline Real GetTMin(int dim) const { return mTMin[dim]; }
        inline Real GetTMax(int dim) const { return mTMax[dim]; }
...
namespace gte
{
    ...
    public:
        ...
        inline int GetNumControls(int) const { return mNumControls; }
        inline Real GetTMin(int) const { return mTMin; }
        inline Real GetTMax(int) const { return mTMax; }
        inline int GetCacheMode() const { return mCacheMode; }

...
template <typename Real>
void DCPQuery<Real, OrientedBox3<Real>, OrientedBox3<Real>>::SetMaxLCPIterations(int maxLCPIterations)
{
    mLCP.SetMaxIterations(maxLCPIterations);
}

template <typename Real>
typename DCPQuery<Real, OrientedBox3<Real>, OrientedBox3<Real>>::Result
    DCPQuery<Real, OrientedBox3<Real>, OrientedBox3<Real>>::operator()(
        OrientedBox3<Real> const& box0, OrientedBox3<Real> const& box1)
{
    Result result;

    // Translate the center of box0 to the origin.  Modify the oriented box

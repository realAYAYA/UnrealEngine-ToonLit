...
#include "SDisplayClusterMoviePipelineEditorSearchableComboBox.h"

////////////////////////////////////////////////////////////////////////////////////////////////
// SDisplayClusterMoviePipelineEditorSearchableComboBox
////////////////////////////////////////////////////////////////////////////////////////////////
void SDisplayClusterMoviePipelineEditorSearchableComboBox::Construct(const FArguments& InArgs)
{
	// Set up content
	...
	if (InArgs._Content.Widget == SNullWidget::NullWidget)
	{
		SAssignNew(ButtonContent, STextBlock)
			.Text(NSLOCTEXT("SDisplayClusterMoviePipelineEditorSearchableComboBox", "ContentWarning", "No Content Provided"))
...
void SDisplayClusterMoviePipelineEditorSearchableComboBox::ResetOptionsSource(const TArray<TSharedPtr<FString>>* NewOptionsSource)
{

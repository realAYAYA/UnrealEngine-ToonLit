...
#ifndef _EasyBlend1SDKFrustum_H_
#define _EasyBlend1SDKFrustum_H_

// This structure is exported from the EasyBlend1SDK.dll
...
} EasyBlend1SDK_Frustum;


#endif /* ifndef _EasyBlend1SDKFrustum_H_ */

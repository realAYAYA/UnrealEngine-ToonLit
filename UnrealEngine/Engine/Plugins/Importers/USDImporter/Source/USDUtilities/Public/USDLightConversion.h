...
namespace UsdToUnreal
{
	...
	USDUTILITIES_API float ConvertRectLightIntensityAttr(
		float UsdIntensity,
		float UsdExposure,
		float UsdWidth,
		float UsdHeight,
	...
	USDUTILITIES_API float ConvertLuxShapingAPIIntensityAttr(
		float UsdIntensity,
		float UsdExposure,
		float UsdRadius,
		float UsdConeAngle,
...
namespace UnrealToUsd
{
	...
	USDUTILITIES_API float ConvertRectLightIntensityProperty(
		float Intensity,
		float Width,
		float Height,
		const FUsdStageInfo& StageInfo,
	...
	USDUTILITIES_API float ConvertRectLightIntensityProperty(
		...
		const FUsdStageInfo& StageInfo,
		ELightUnits SourceUnits
	);	  // For RectLight -> UsdLuxDiskLight
	USDUTILITIES_API float ConvertPointLightIntensityProperty(
		float Intensity,
		float SourceRadius,
		const FUsdStageInfo& StageInfo,
		ELightUnits SourceUnits
	);
	USDUTILITIES_API float ConvertSpotLightIntensityProperty(
		float Intensity,

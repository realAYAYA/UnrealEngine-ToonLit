...
void SUsdVariantRow::Construct(
	const FArguments& InArgs,
	TSharedPtr<FUsdVariantSetViewModel> InVariantSet,
...
)
{
	...
	SMultiColumnTableRow<TSharedPtr<FUsdVariantSetViewModel>>::Construct(
		SMultiColumnTableRow<TSharedPtr<FUsdVariantSetViewModel>>::FArguments(),
		OwnerTable
	);
}
...
{
	return SNew(SUsdVariantRow, InDisplayNode, OwnerTable).OnVariantSelectionChanged(this, &SVariantsList::OnVariantSelectionChanged);
}

...
UCLASS(EditInlineNew, Category = "Texture", CollapseCategories, meta = (DisplayName = "Volume Texture Sample"), MinimalAPI)
...
public:
	...
	NIAGARA_API void SampleVolumeTexture(FVectorVMExternalFunctionContext& Context);
...
protected:
	...
	static NIAGARA_API const FName LoadVolumeTextureName;
	static NIAGARA_API const FName SampleVolumeTextureName;

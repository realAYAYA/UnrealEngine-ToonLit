...
class JSONSERIALIZATION_API FJsonArchiveInputFormatterEx final : public FStructuredArchiveFormatter
{
public:
	FJsonArchiveInputFormatterEx(FArchive& InInner, UObject* InRootObject, TFunction<UObject* (const FPackageIndex)> InResolveObject = nullptr);
	virtual ~FJsonArchiveInputFormatterEx() override;

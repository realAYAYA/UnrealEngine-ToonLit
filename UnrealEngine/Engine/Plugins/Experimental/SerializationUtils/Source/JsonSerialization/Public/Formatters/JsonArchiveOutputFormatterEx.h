...
class JSONSERIALIZATION_API FJsonArchiveOutputFormatterEx : public FStructuredArchiveFormatter
{
public:
	FJsonArchiveOutputFormatterEx(FArchive& InInner);
	virtual ~FJsonArchiveOutputFormatterEx() override;

...
#if defined(PLATFORM_NNE_MICROSOFT) // WITH_UE: Replaced PLATFORM_WINDOWS with PLATFORM_NNE_MICROSOFT
...
#elif defined(PLATFORM_NNE_MICROSOFT) // WITH_UE: Replaced PLATFORM_WINDOWS with PLATFORM_NNE_MICROSOFT
    unsigned long index;
#if defined(_WIN64)

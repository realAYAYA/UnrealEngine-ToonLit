...
#if defined(__PROSPERO__) // WITH_UE
// note: max 32B alignment supported (SDK 6). Check again with newer SDKs. See https://p.siedev.net/forums/thread/183140/
#define ORT_FALSE_SHARING_BYTES 32

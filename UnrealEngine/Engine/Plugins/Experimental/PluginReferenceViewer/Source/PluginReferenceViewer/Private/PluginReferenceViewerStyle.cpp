...
FName FPluginReferenceViewerStyle::StyleName("PluginReferenceViewerStyle");

#define FONT(...) FSlateFontInfo(FCoreStyle::GetDefaultFont(), __VA_ARGS__)

FPluginReferenceViewerStyle::FPluginReferenceViewerStyle()
...
FPluginReferenceViewerStyle& FPluginReferenceViewerStyle::Get()
{
	static FPluginReferenceViewerStyle Inst;
	return Inst;
}

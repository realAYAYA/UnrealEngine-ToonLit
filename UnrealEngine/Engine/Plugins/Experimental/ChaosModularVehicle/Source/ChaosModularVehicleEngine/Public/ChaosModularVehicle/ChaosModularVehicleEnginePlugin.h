...
public:
	 ...
	 */
	static inline IChaosModularVehicleEnginePlugin& Get()
	{
		return FModuleManager::LoadModuleChecked< IChaosModularVehicleEnginePlugin >( "ChaosModularVehicleEngine" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "ChaosModularVehicleEngine" );
	}

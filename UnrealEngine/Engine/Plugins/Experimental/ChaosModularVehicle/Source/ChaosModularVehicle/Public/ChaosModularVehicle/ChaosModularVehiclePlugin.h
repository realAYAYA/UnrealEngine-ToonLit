...
public:
	 ...
	 */
	static inline IChaosModularVehiclePlugin& Get()
	{
		return FModuleManager::LoadModuleChecked< IChaosModularVehiclePlugin >("ChaosModularVehicle");
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded("ChaosModularVehicle");
	}

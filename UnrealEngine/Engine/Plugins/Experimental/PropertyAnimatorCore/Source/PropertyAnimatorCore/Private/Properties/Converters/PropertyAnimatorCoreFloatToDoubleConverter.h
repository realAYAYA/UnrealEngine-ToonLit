...
#include "PropertyAnimatorCoreFloatToDoubleConverter.generated.h"

UCLASS(Transient)
class UPropertyAnimatorCoreFloatToDoubleConverter : public UPropertyAnimatorCoreConverterBase
{
	GENERATED_BODY()

...
class FAvaShapeEllipseDynamicMeshVisualizer : public FAvaShape2DDynamicMeshVisualizer
{
public:

	using Super = FAvaShape2DDynamicMeshVisualizer;
	using FMeshType = UAvaShapeEllipseDynamicMesh;

	FAvaShapeEllipseDynamicMeshVisualizer();

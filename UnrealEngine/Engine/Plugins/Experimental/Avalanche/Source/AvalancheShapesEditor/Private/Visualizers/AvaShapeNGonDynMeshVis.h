...
class FAvaShapeNGonDynamicMeshVisualizer : public FAvaShapeRoundedPolygonDynamicMeshVisualizer
{
public:
	using Super = FAvaShapeRoundedPolygonDynamicMeshVisualizer;
	using FMeshType = UAvaShapeNGonDynamicMesh;

	FAvaShapeNGonDynamicMeshVisualizer();

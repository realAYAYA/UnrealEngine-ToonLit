...
class FAvaRundownPageTransitionLayerColumn : public IAvaRundownPageViewColumn
{
public:
	UE_AVA_INHERITS(FAvaRundownPageTransitionLayerColumn, IAvaRundownPageViewColumn);

...
struct FStructUtilsTest_InstancedStructStreamBasic : FAITestBase
{
	...
	{
		FInstancedStructStream Buffer(1234);
...
IMPLEMENT_AI_INSTANT_TEST(FStructUtilsTest_InstancedStructStreamBasic, "System.StructUtils.InstancedStructStream.Basic");

struct FStructUtilsTest_InstancedStructStreamAppend : FAITestBase
{
	virtual bool InstantTest() override
	{
		FInstancedStructStream Buffer1(64);
		FInstancedStructStream Buffer2(64);
		FInstancedStructStream Buffer3(64);
...
IMPLEMENT_AI_INSTANT_TEST(FStructUtilsTest_InstancedStructStreamAppend, "System.StructUtils.InstancedStructStream.Append");


struct FStructUtilsTest_InstancedStructStreamFreelist : FAITestBase
{
	virtual bool InstantTest() override
	{
		FInstancedStructStream Buffer(64);
...
IMPLEMENT_AI_INSTANT_TEST(FStructUtilsTest_InstancedStructStreamFreelist, "System.StructUtils.InstancedStructStream.Freelist");


struct FStructUtilsTest_InstancedStructStreamForEach : FAITestBase
{
	virtual bool InstantTest() override
	{
		FInstancedStructStream Buffer;

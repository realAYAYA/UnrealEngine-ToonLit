 ...
 */
class ANALYTICS_API FAnalyticsPropertyStore : public IAnalyticsPropertyStore
{
public:
	 ...
	 */
	bool Create(const FString& Pathname, uint32 CapacityHint = 4 * 1024);
	...
	virtual bool Contains(const FString& Key) const override;
	virtual bool Remove(const FString& Key) override;
	virtual void RemoveAll() override;
	virtual EStatusCode Set(const FString& Key, int32 Value) override;
	virtual EStatusCode Set(const FString& Key, uint32 Value) override;
	virtual EStatusCode Set(const FString& Key, int64 Value) override;
	virtual EStatusCode Set(const FString& Key, uint64 Value) override;
	virtual EStatusCode Set(const FString& Key, float Value) override;
	virtual EStatusCode Set(const FString& Key, double Value) override;
	virtual EStatusCode Set(const FString& Key, bool Value) override;
	virtual EStatusCode Set(const FString& Key, const FString& Value, uint32 CharCountCapacityHint = 0) override;
	virtual EStatusCode Set(const FString& Key, const FDateTime& Value) override;
	virtual EStatusCode Set(const FString& Key, int32 Value, const TFunction<bool(const int32* /*Actual*/, const int32& /*Proposed*/)>& ConditionFn) override;
	virtual EStatusCode Set(const FString& Key, uint32 Value, const TFunction<bool(const uint32* /*Actual*/, const uint32& /*Proposed*/)>& ConditionFn) override;
	virtual EStatusCode Set(const FString& Key, int64 Value, const TFunction<bool(const int64* /*Actual*/, const int64& /*Proposed*/)>& ConditionFn) override;
	...
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(uint32&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(int64&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(uint64&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(float&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(double&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(bool&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(FString&)>& UpdateFn) override;
	virtual EStatusCode Update(const FString& Key, const TFunction<bool(FDateTime&)>& UpdateFn) override;
	virtual EStatusCode Get(const FString& Key, int32& OutValue) const override;
	virtual EStatusCode Get(const FString& Key, uint32& OutValue) const override;
	virtual EStatusCode Get(const FString& Key, int64& OutValue) const override;
	virtual EStatusCode Get(const FString& Key, uint64& OutValue) const override;
	virtual EStatusCode Get(const FString& Key, float& OutValue) const override;
	virtual EStatusCode Get(const FString& Key, double& OutValue) const override;
	 ...
	 * @endcode
	 */
	virtual bool Flush(bool bAsync = false, const FTimespan& Timeout = FTimespan::MaxValue()) override;
...
private:
	EStatusCode SetFixedSizeValueInternal(const FString& Key, ETypeCode TypeCode, const uint8* Value, uint32 Size);
	EStatusCode GetFixedSizeValueInternal(const FString& Key, ETypeCode TypeCode, uint8* OutValue, uint32 Size) const;
	EStatusCode SetStringValueInternal(const FString& Key, const FString& Value, uint32 CharCountCapacityHint = 0);
	EStatusCode GetStringValueInternal(const FString& Key, FString& OutValue) const;
	EStatusCode SetDateTimeValueInternal(const FString& Key, const FDateTime& Value);
	EStatusCode GetDateTimeValueInternal(const FString& Key, FDateTime& OutValue) const;
	void Defragment();
	...
	void FlushInternal(const TArray<uint8>& Data);
	void Reset();

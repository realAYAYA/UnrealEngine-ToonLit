...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FIspcTestAnimEncodingConstantKeyLerpGetPoseRotations, "Ispc.Animation.ConstantKeyLerp.GetPoseRotations", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FIspcTestAnimEncodingConstantKeyLerpGetPoseRotations::RunTest(const FString& Parameters)
{
	...
	CompressedData.KeyEncodingFormat = AKF_ConstantKeyLerp;
	...
	{
		AEFConstantKeyLerp<ACF_Identity> KeyLerp;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FIspcTestAnimEncodingConstantKeyLerpGetPoseTranslations, "Ispc.Animation.ConstantKeyLerp.GetPoseTranslations", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FIspcTestAnimEncodingConstantKeyLerpGetPoseScales, "Ispc.Animation.ConstantKeyLerp.GetPoseScales", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

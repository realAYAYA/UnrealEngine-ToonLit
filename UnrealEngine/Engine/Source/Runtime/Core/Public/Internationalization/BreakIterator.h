...
struct FBreakIterator
{
	 ...
	 */
	static CORE_API TSharedRef<IBreakIterator> CreateCharacterBoundaryIterator();

	/**
	 * Create a new instance of a break iterator designed to locate word boundary points within a string
	 */
	static CORE_API TSharedRef<IBreakIterator> CreateWordBreakIterator();
	 ...
	 */
	static CORE_API TSharedRef<IBreakIterator> CreateLineBreakIterator();
	 ...
	 */
	static CORE_API TSharedRef<IBreakIterator> CreateCamelCaseBreakIterator();
};

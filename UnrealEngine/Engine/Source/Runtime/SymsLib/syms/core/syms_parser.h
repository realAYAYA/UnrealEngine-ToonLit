...
typedef union SYMS_UnitAccel{
  ...
  SYMS_PdbUnitAccel pdb_accel;
} SYMS_UnitAccel;

typedef union SYMS_MemsAccel{
  SYMS_FileFormat format;
  SYMS_DwMemsAccel dw_accel;
  SYMS_PdbMemsAccel pdb_accel;
} SYMS_MemsAccel;
...
SYMS_API SYMS_UnitRangeArray syms_unit_ranges_from_set(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
...
// symbol parsing
SYMS_API SYMS_UnitAccel*    syms_unit_accel_from_uid(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
...
SYMS_API SYMS_String8       syms_symbol_name_from_sid(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
                                                      SYMS_UnitAccel *unit, SYMS_SymbolID sid);


SYMS_API SYMS_TypeInfo      syms_type_info_from_sid(SYMS_String8 data, SYMS_DbgAccel *dbg, SYMS_UnitAccel *unit,
                                                    SYMS_SymbolID sid);

SYMS_API SYMS_ConstInfo     syms_const_info_from_sid(SYMS_String8 data, SYMS_DbgAccel *dbg, SYMS_UnitAccel *unit,
                                                     SYMS_SymbolID sid);

// variable info
SYMS_API SYMS_USID         syms_type_from_var_sid(SYMS_String8 data, SYMS_DbgAccel *dbg, SYMS_UnitAccel *unit,
                                                  SYMS_SymbolID sid);
...
SYMS_API SYMS_MemInfo      syms_mem_info_from_number(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
                                                     SYMS_UnitAccel *unit, SYMS_MemsAccel *mems, SYMS_U64 n);

SYMS_API SYMS_USID         syms_type_from_mem_number(SYMS_String8 data, SYMS_DbgAccel *dbg, SYMS_UnitAccel *unit,
                                                     SYMS_MemsAccel *mems, SYMS_U64 n);
SYMS_API SYMS_SigInfo      syms_sig_info_from_mem_number(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
                                                         SYMS_UnitAccel *unit, SYMS_MemsAccel *mems, SYMS_U64 n);
...
// line info
SYMS_API SYMS_String8      syms_file_name_from_id(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
                                                  SYMS_UnitSetAccel *unit_set, SYMS_UnitID uid,
                                                  SYMS_FileID file_id);
SYMS_API SYMS_String8Array syms_file_table_from_uid(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
                                                    SYMS_UnitSetAccel *unit_set, SYMS_UnitID uid);
SYMS_API SYMS_LineParseOut syms_line_parse_from_uid(SYMS_Arena *arena, SYMS_String8 data, SYMS_DbgAccel *dbg,
                                                    SYMS_UnitSetAccel *unit_set, SYMS_UnitID uid);

...
namespace mtlpp
{
	enum class PixelFormat : NSUInteger
    {
        ...
        R8Unorm                                            = 10,
        R8Unorm_sRGB          MTLPP_AVAILABLE(11_0, 8_0)   = 11,
        ...
        PVRTC_RGB_2BPP        MTLPP_AVAILABLE(11_0, 8_0)   = 160,
        PVRTC_RGB_2BPP_sRGB   MTLPP_AVAILABLE(11_0, 8_0)   = 161,
        PVRTC_RGB_4BPP        MTLPP_AVAILABLE(11_0, 8_0)   = 162,
        PVRTC_RGB_4BPP_sRGB   MTLPP_AVAILABLE(11_0, 8_0)   = 163,
        PVRTC_RGBA_2BPP       MTLPP_AVAILABLE(11_0, 8_0)   = 164,
        PVRTC_RGBA_2BPP_sRGB  MTLPP_AVAILABLE(11_0, 8_0)   = 165,
        PVRTC_RGBA_4BPP       MTLPP_AVAILABLE(11_0, 8_0)   = 166,
        PVRTC_RGBA_4BPP_sRGB  MTLPP_AVAILABLE(11_0, 8_0)   = 167,
        ...
        ASTC_4x4_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 186,
        ASTC_5x4_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 187,
        ASTC_5x5_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 188,
        ASTC_6x5_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 189,
        ASTC_6x6_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 190,
        ASTC_8x5_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 192,
        ASTC_8x6_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 193,
        ASTC_8x8_sRGB         MTLPP_AVAILABLE(11_0, 8_0)   = 194,
        ASTC_10x5_sRGB        MTLPP_AVAILABLE(11_0, 8_0)   = 195,
        ASTC_10x6_sRGB        MTLPP_AVAILABLE(11_0, 8_0)   = 196,
        ASTC_10x8_sRGB        MTLPP_AVAILABLE(11_0, 8_0)   = 197,
        ASTC_10x10_sRGB       MTLPP_AVAILABLE(11_0, 8_0)   = 198,
        ASTC_12x10_sRGB       MTLPP_AVAILABLE(11_0, 8_0)   = 199,
        ASTC_12x12_sRGB       MTLPP_AVAILABLE(11_0, 8_0)   = 200,

        ASTC_4x4_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 204,
        ASTC_5x4_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 205,
        ASTC_5x5_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 206,
        ASTC_6x5_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 207,
        ASTC_6x6_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 208,
        ASTC_8x5_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 210,
        ASTC_8x6_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 211,
        ASTC_8x8_LDR          MTLPP_AVAILABLE(11_0, 8_0)   = 212,
        ASTC_10x5_LDR         MTLPP_AVAILABLE(11_0, 8_0)   = 213,
        ASTC_10x6_LDR         MTLPP_AVAILABLE(11_0, 8_0)   = 214,
        ASTC_10x8_LDR         MTLPP_AVAILABLE(11_0, 8_0)   = 215,

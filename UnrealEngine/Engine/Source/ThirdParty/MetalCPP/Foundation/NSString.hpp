...
public:
    ...
    String*          initNoCopy(void* pBytes, UInteger len, StringEncoding encoding, bool freeBuffer);
...
_NS_INLINE NS::String* NS::String::initNoCopy(void* pBytes, UInteger len, StringEncoding encoding, bool freeBuffer)
{

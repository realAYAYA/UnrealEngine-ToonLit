...
#pragma once
    ...
    /*#define MIDL_INTERFACE(guid) interface

    #define DECLARE_INTERFACE(name) struct name
    #define DECLARE_INTERFACE_(name, parent) struct name : parent

    #define DEFINE_GUID(id, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10)

    #define STDMETHOD(name) virtual HRESULT name
    #define STDMETHOD_(result, name) virtual result name
*/
    #define THIS_ // I guess some placeholder for when the C compiler runs over it ? probably like 'void *,'
    #define THIS  // I guess some placeholder for when the C compiler runs over it ? probably like 'void *'
    
    #define PURE = 0 // '= 0' for pure virtual class methods

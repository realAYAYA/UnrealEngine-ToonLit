...
#ifndef __DVAPI_D3D10_H_
#define __DVAPI_D3D10_H_
...
DVPAPI_INTERFACE
dvpInitD3D10Device(ID3D10Device *pD3D10Device,
                   uint32_t flags);

DVPAPI_INTERFACE
dvpCloseD3D10Device(ID3D10Device *pD3D10Device);


DVPAPI_INTERFACE
dvpBindToD3D10Device(DVPBufferHandle hBuf,

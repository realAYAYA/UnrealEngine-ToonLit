...
cd $MAKE_PATH_SIM
cmake -G"Xcode" -DCMAKE_TOOLCHAIN_FILE=../../iOS.cmake -DCMAKE_BUILD_TYPE="Release" -DCMAKE_PROJECT_INCLUDE=$PATH_IOS_TOOLCHAIN/TPS.cmake -DTPS_INCLUDE_PATHS="$LIB_PNG_PATH;$ZLIB_PATH" -DCMAKE_C_COMPILER="/usr/bin/clang" -DCMAKE_CXX_COMPILER="/usr/bin/clang++" -DCMAKE_CXX_FLAGS="$CXXFLAGS" -DCMAKE_IOS_DEPLOYMENT_TARGET=15.0 -DIOS_PLATFORM=SIMULATOR -DCMAKE_DISABLE_FIND_PACKAGE_BZip2=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_ZLIB=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_PNG=TRUE $PATH_TO_CMAKE_FILE

...
# Move this script into the libjpeg-turbo source folder, and then run
# Requires setting up LINUX_MULTIARCH_ROOT to one of our internal toolchains
...
BuildLibjpeg x86_64-unknown-linux-gnu Debug
BuildLibjpeg x86_64-unknown-linux-gnu Release
BuildLibjpeg aarch64-unknown-linux-gnueabi Debug
BuildLibjpeg aarch64-unknown-linux-gnueabi Release

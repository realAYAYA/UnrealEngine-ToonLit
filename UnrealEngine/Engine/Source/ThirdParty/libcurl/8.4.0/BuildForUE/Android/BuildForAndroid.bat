...
call "%ENGINE_ROOT%/Build/BatchFiles/RunUAT.bat" BuildCMakeLib -TargetPlatform=Android -TargetArchitecture=ARM64 -TargetLib=libcurl -TargetLibVersion=%LIBCURL_VERSION% -TargetLibSourcePath=%TARGET_LIB_SOURCE_PATH% -TargetConfigs=Release -LibOutputPath=lib -CMakeGenerator=Makefile -CMakeAdditionalArguments="%CMAKE_ADDITIONAL_ARGUMENTS% %CMAKE_OPENSSL_ARGUMENTS% %CMAKE_ZLIB_ARGUMENTS% %CMAKE_NGHTTP2_ARGUMENTS%" -SkipCreateChangelist || exit /b
...
call "%ENGINE_ROOT%/Build/BatchFiles/RunUAT.bat" BuildCMakeLib -TargetPlatform=Android -TargetArchitecture=x64 -TargetLib=libcurl -TargetLibVersion=%LIBCURL_VERSION% -TargetLibSourcePath=%TARGET_LIB_SOURCE_PATH% -TargetConfigs=Release -LibOutputPath=lib -CMakeGenerator=Makefile -CMakeAdditionalArguments="%CMAKE_ADDITIONAL_ARGUMENTS% %CMAKE_OPENSSL_ARGUMENTS% %CMAKE_ZLIB_ARGUMENTS% %CMAKE_NGHTTP2_ARGUMENTS%" -SkipCreateChangelist || exit /b

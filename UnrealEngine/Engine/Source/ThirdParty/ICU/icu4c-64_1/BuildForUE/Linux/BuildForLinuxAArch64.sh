...
BuildLibICU()
{
    ...
    export FLAVOR=$2
    local EXT=$3
    local BUILD_DIR=/tmp/Build-ICU-${ARCH}-${FLAVOR}
    ...
    mkdir -p ${ICU_DIR}/lib/Linux/${ARCH}
    cp -v ${BUILD_DIR}/libicu.a ${ICU_DIR}/lib/Linux/${ARCH}/libicu${EXT}_fPIC.a
...
BuildLibICU ${ARCH} Release ""
BuildLibICU ${ARCH} Debug "d"

...
CXXFLAGS="-ffunction-sections -fdata-sections -I$UE_THIRD_PARTY_DIR/Linux/LibCxx/include -I$UE_THIRD_PARTY_DIR/Linux/LibCxx/include/c++/v1"
...
make -j4
cp -v ../libicu.a "$BASE_DIR/../lib/Linux/$ARCH/libicu_fPIC.a"
...
make -j4
cp -v ../libicu.a "$BASE_DIR/../lib/Linux/$ARCH/libicud_fPIC.a"

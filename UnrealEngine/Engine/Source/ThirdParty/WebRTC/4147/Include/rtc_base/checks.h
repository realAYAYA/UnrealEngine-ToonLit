...
#ifndef WEBRTC_EXTENSION_FATAL_LOG_CALLBACK
#define WEBRTC_EXTENSION_FATAL_LOG_CALLBACK 1
#endif

#if WEBRTC_EXTENSION_FATAL_LOG_CALLBACK
#ifdef __cplusplus
extern "C" {
#endif
typedef void (*rtc_OnFatalLogCallback_t)(const char* message);
void rtc_SetFatalLogCallback(rtc_OnFatalLogCallback_t callback);
#ifdef __cplusplus
}  // extern "C"
#endif
#endif

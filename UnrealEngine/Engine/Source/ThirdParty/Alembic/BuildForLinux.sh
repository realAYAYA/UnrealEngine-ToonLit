...
UsageAndExit()
{
    ...
    echo "Usage examples:"
    echo
    echo "    $BUILD_SCRIPT_NAME 1.8.6 x86_64-unknown-linux-gnu"
    echo "      -- Installs $LIBRARY_NAME version 1.8.6 for x86_64 architecture."
    echo
    echo "    $BUILD_SCRIPT_NAME 1.8.6 aarch64-unknown-linux-gnueabi"
    echo "      -- Installs $LIBRARY_NAME version 1.8.6 for arm64 architecture."
    echo
    exit 1
}

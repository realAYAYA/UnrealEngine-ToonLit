...
if(__boost_variants AND NOT __boost_configs)
  message(STATUS "No suitable boost_program_options variant has been identified!")
  if(NOT Boost_DEBUG)
  ...
  set(boost_program_options_NOT_FOUND_MESSAGE "No suitable build variant has been found.")
...
foreach(dep_boost_program_options IN LISTS _BOOST_PROGRAM_OPTIONS_DEPS)
  ...
  get_filename_component(_BOOST_CMAKEDIR "${CMAKE_CURRENT_LIST_DIR}/../" ABSOLUTE)
  find_package(boost_${dep_boost_program_options} 1.70.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})

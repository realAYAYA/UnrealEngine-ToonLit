...
static v4sf tancot_ps( v4sf x, int cotFlag )
{
...
const float PIF = (float)3.141592653589793238;
const float PIO2F = (float)1.5707963267948966192;
...
v4sf atan2_ps( v4sf y, v4sf x )
{
	...
	v4sf pi_result = _mm_and_ps( pi_mask, *(v4sf*)_ps_cephes_PIF );

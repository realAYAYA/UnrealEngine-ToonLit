...
namespace EpicGames.UHT.Types
{
	...
	public class UhtOptionalProperty : UhtContainerBaseProperty
	{
		...
		public UhtOptionalProperty(UhtPropertySettings propertySettings, UhtProperty value) : base(propertySettings, value)
		{
			...
			ValueProperty.PropertyFlags = PropertyFlags & EPropertyFlags.PropagateToOptionalInner;
		...
		public override StringBuilder AppendText(StringBuilder builder, UhtPropertyTextType textType, bool isTemplateArgument)
		{
			switch (textType)
			{
				...
				default:
					builder.Append("TOptional<").AppendPropertyText(ValueProperty, textType, true);
					if (builder[^1] == '>')
					{

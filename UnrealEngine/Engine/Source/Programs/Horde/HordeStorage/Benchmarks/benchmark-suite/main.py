...
def main():
    parser = argparse.ArgumentParser(
        description="Horde.Storage Benchmarker - Tool for benchmarking Horde.Storage")
    ...
    logging.info("Horde.Storage Benchmarker")
    ...
    if (not hasDoneSomething):
        ...
        logging.info("Horde.Storage Benchmarker finished its run")

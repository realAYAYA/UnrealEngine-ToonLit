import { Async, classNamesFunction, getId, getGlobalClassNames, IAutofill, IBasePicker, IBasePickerProps, IBasePickerState, IBasePickerStyleProps, IBasePickerStyles, IFocusZone, initializeComponentRef, IPickerAriaIds, ISuggestions, ISuggestionsProps, ISuggestionsStyleProps, ISuggestionsStyles, styled, Selection, Suggestions, SuggestionsController, KeyCodes, IProcessedStyleSet, FocusZone, FocusZoneDirection, SelectionZone, Autofill, SelectionMode, Callout, DirectionalHint, IPickerItemProps, elementContains, ValidationState, IStyle, HighContrastSelector, getHighContrastNoAdjustStyle, hiddenContentStyle, IPersonaProps } from "@fluentui/react";
...
const GlobalClassNames = {
  ...
  export function getSuggestionStyles(props: ISuggestionsStyleProps): ISuggestionsStyles {
 ...
 * {@docCategory Pickers}
 */
export class HBasePicker<T, P extends IBasePickerProps<T>> extends React.Component<P, IBasePickerState<T>>
  ...
  public render(): JSX.Element {
    ...
    const classNames: Partial<IProcessedStyleSet<IBasePickerStyles>> = getClassNames(styles, {
        theme,
        className,
        isFocused,
        disabled,
    ...
    return (
      <div ref={this.root} className={classNames.root} onKeyDown={this.onKeyDown} onBlur={this.onBlur}>
        ...
        >
          {this.getSuggestionsAlert(classNames.screenReaderText as any)}
  ...
  protected onSuggestionRemove = (ev?: React.MouseEvent<HTMLElement> | undefined, item?: IPersonaProps | T | undefined, index?: number | undefined): void => {
      if(item && index) {
        if (this.props.onRemoveSuggestion) {
            this.props.onRemoveSuggestion(item as T);
          }
  ...
  protected getSuggestionsAlert(suggestionAlertClassName: string | undefined) {
    const currentIndex = this.suggestionStore.currentIndex;
...
export class BasePickerListBelow<T, P extends IBasePickerProps<T>> extends HBasePicker<T, P> {
  public render(): JSX.Element {

...
import { ICartesianChartStyleProps, ICartesianChartStyles, IChartHoverCardProps, IChildProps, ILegendsProps, IMargins, IYValueHover } from '@fluentui/react-charting';
import { ChartTypes, XAxisTypes, YAxisType } from '@fluentui/react-charting/lib/utilities/utilities';

export interface IHCartesianChartStyleProps {
  /**
...
export interface IHCartesianChartStyles {
  /**
...
export interface IHCartesianChartProps {
  /**
...
export interface IHModifiedCartesianChartProps extends IHCartesianChartProps {
  /**

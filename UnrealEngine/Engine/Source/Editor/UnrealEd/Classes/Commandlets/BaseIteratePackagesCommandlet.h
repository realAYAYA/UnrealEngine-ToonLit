...
class UNREALED_API UBaseIteratePackagesCommandlet : public UCommandlet
{
...
protected:
	 ...
	 */
	virtual int32 InitializeParameters( const TArray<FString>& Tokens, TArray<FString>& MapPathNames );

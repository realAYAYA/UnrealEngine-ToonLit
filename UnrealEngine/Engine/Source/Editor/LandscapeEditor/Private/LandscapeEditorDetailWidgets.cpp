...
void SToolSelector::BuildMultiBlockWidget(const ISlateStyle* StyleSet, const FName& StyleName)
{
	...
	static FTextBlockStyle SmallTextStyle = FTextBlockStyle(LabelStyle).SetFontSize(static_cast<uint16>(LabelStyle.Font.Size - 1)).SetColorAndOpacity(FSlateColor::UseSubduedForeground());

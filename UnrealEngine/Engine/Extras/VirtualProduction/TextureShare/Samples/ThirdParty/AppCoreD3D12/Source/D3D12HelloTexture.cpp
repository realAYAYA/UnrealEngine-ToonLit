...
static FD3D12TextureShareSample* GTextureShareSample = nullptr;
...
void D3D12HelloTexture::LoadPipeline()
{
	...
	swapChainDesc.Format = D3D12AppSetup::Backbuffer::Format;
    ...
    // Create descriptor heaps.
    {
		...
		srvHeapDesc.NumDescriptors = (int)EResourceSRV::COUNT;
...
void D3D12HelloTexture::LoadAssets()
{
    ...
    // Create the pipeline state, which includes compiling and loading shaders.
    {
		...
		psoDesc.RTVFormats[0] = D3D12AppSetup::Backbuffer::Format;
    ...
    // Create the vertex buffer.
    {
        ...
        {
            { { -1.f,  0.5f * m_aspectRatio, 0.0f }, { 0.0f, 0.0f } },
            { {  0.f, -0.5f * m_aspectRatio, 0.0f }, { 1.0f, 1.0f } },
            { { -1.f, -0.5f * m_aspectRatio, 0.0f }, { 0.0f, 1.0f } },

			{ {  0.f,  0.5f * m_aspectRatio, 0.0f }, { 1.0f, 0.0f } },
			{ {  0.f, -0.5f * m_aspectRatio, 0.0f }, { 1.0f, 1.0f } },
			{ { -1.f,  0.5f * m_aspectRatio, 0.0f }, { 0.0f, 0.0f } },
		};
		...
		CD3DX12_RESOURCE_DESC ResourceBuffer = CD3DX12_RESOURCE_DESC::Buffer(vertexBufferSize);
	...
	// VB 2
	{
		...
		Vertex triangleVertices[] =
		{
			{ {  0.f,  0.5f * m_aspectRatio, 0.0f }, { 0.0f, 0.0f } },
			{ {  1.f, -0.5f * m_aspectRatio, 0.0f }, { 1.0f, 1.0f } },
			{ {  0.f, -0.5f * m_aspectRatio, 0.0f }, { 0.0f, 1.0f } },

			{ {  1.f,  0.5f * m_aspectRatio, 0.0f }, { 1.0f, 0.0f } },
			{ {  1.f, -0.5f * m_aspectRatio, 0.0f }, { 1.0f, 1.0f } },
			{ {  0.f,  0.5f * m_aspectRatio, 0.0f }, { 0.0f, 0.0f } },
		};
    ...
    // Create the texture.
    {
		...
		textureDesc.Format = D3D12AppSetup::Backbuffer::Format;
		...
		CD3DX12_HEAP_PROPERTIES HeapPropTypeUpload(D3D12_HEAP_TYPE_UPLOAD);
		...
		const CD3DX12_RESOURCE_BARRIER CopyDestResourceBarrier = CD3DX12_RESOURCE_BARRIER::Transition(m_texture.Get(), D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE);
        m_commandList->ResourceBarrier(1, &CopyDestResourceBarrier);
...
void D3D12HelloTexture::OnUpdate()
{
	...
	{
		GTextureShareSample = new FD3D12TextureShareSample(m_renderTargets[m_frameIndex].Get());
	}
	//////////////////////////////////////////////////////////////////////////////////////////////
}
...
void D3D12HelloTexture::PopulateCommandList()
{
	...
	const CD3DX12_RESOURCE_BARRIER RTTResourceBarrier = CD3DX12_RESOURCE_BARRIER::Transition(m_renderTargets[m_frameIndex].Get(), D3D12_RESOURCE_STATE_PRESENT, D3D12_RESOURCE_STATE_RENDER_TARGET);
	m_commandList->ResourceBarrier(1, &RTTResourceBarrier);
	...
	const FTextureShareDeviceContextD3D12 D3D12DeviceContext(m_device.Get(), m_commandList.Get(), m_srvHeap.Get());
	...
	if (GTextureShareSample)
	{
		...
		if (GTextureShareSample->IsFrameSyncActive_RenderThread())
		{
			...
			SRVIndex1 = GTextureShareSample->GetReceiveTextureSRV(1);
		}
	}
	//////////////////////////////////////////////////////////////////////////////////////////////

	ImplRenderTri(&m_vertexBufferView,  (SRVIndex0 >= 0) ? SRVIndex0 : 0);
	ImplRenderTri(&m_vertexBufferView2, (SRVIndex1 >= 0) ? SRVIndex1 : 0);

	//////////////////////////////////////////////////////////////////////////////////////////////
	// TextureShare
	if (GTextureShareSample)
	{
		GTextureShareSample->EndFrame(D3D12DeviceContext, m_renderTargets[m_frameIndex].Get());
	}
	//////////////////////////////////////////////////////////////////////////////////////////////

	// Indicate that the back buffer will now be used to present.
	const CD3DX12_RESOURCE_BARRIER PresentResourceBarrier = CD3DX12_RESOURCE_BARRIER::Transition(m_renderTargets[m_frameIndex].Get(), D3D12_RESOURCE_STATE_RENDER_TARGET, D3D12_RESOURCE_STATE_PRESENT);

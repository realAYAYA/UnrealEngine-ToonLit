...
import { IHCartesianChartStyleProps, IHModifiedCartesianChartProps } from './HCartesianChart.types';
import { ChartHoverCard, ICartesianChartStyles, IMargins, IModifiedCartesianChartProps, IYValueHover, LegendShape, Shape } from '@fluentui/react-charting';
import { createDateXAxis, createStringXAxis, createStringYAxis, createWrapOfXLabels, getDomainNRangeValues, getMinMaxOfYAxis, Points, pointTypes, XAxisTypes, YAxisType } from '@fluentui/react-charting/lib/utilities/utilities';
import { hCreateNumericXAxis, hCreateYAxis } from '../Hutilities';

const getClassNames = classNamesFunction<IHCartesianChartStyleProps, ICartesianChartStyles>();
 ...
 */
export class HCartesianChartBase extends React.Component<IHModifiedCartesianChartProps, ICartesianChartState> {
  private _classNames: IProcessedStyleSet<ICartesianChartStyles> | undefined;
  private chartContainer: HTMLDivElement | undefined;
  private legendContainer: HTMLDivElement | undefined;
  private minLegendContainerHeight: number = 32;
  private xAxisElement: SVGElement | null | undefined;
  private yAxisElement: SVGElement | null | undefined;
  private margins: IMargins;
  private idForGraph: string;
  private _reqID: number | undefined;
  private _isRtl: boolean = getRTL();

  constructor(props: IHModifiedCartesianChartProps) {
    super(props);
    this.state = {
      containerHeight: 0,
      containerWidth: 0,
  ...
  public render(): JSX.Element {
    ...
    if(this.props.getmargins) {
      let newMargins = this.props.getmargins();
      if(newMargins) {
    ...
    switch (this.props.xAxisType!) {
      case XAxisTypes.NumericAxis:
        xScale = hCreateNumericXAxis(XAxisParams, this.props.tickParams);
        break;
    ...
    if (this.props.yAxisType && this.props.yAxisType === YAxisType.StringAxis) {
      ...
      yScale = hCreateYAxis(YAxisParams, this._isRtl);
    }

...
BuildShaderConductor()
{
    ...
    cmake -G Ninja \
      ...
      -DCROSS_TOOLCHAIN_FLAGS_NATIVE="-DCMAKE_TOOLCHAIN_FILE=\"/tmp/__cmake_toolchain.cmake\";-DCMAKE_MAKE_PROGRAM=$(which ninja);-DCMAKE_BUILD_TYPE=${FLAVOR};-DSC_ARCH_NAME=x64;-DPYTHON_EXECUTABLE=$(which python3);-DPython3_EXECUTABLE=$(which python3);-DSPIRV_CROSS_ENABLE_TESTS=OFF;-DSC_EXPLICIT_DLLSHUTDOWN=ON;-DDXC_EXPLICIT_DLLSHUTDOWN=ON" \

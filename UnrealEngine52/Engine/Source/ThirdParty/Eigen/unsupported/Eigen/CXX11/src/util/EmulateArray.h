 ...
 */
// EPIC BEGIN
// EPIC NOTE - allow custom version of STD_GET_ARR_HACK for platforms with incompatible version of libc++
#ifdef EIGEN_STD_GET_ARR_HACK
#define STD_GET_ARR_HACK			EIGEN_STD_GET_ARR_HACK
#elif defined(__GLIBCXX__) && __GLIBCXX__ < 20120322
// EPIC END

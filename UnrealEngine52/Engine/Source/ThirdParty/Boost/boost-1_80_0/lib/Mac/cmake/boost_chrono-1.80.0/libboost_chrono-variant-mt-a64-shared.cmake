...
if(DEFINED Boost_USE_STATIC_LIBS)
  ...
  if(WIN32 AND NOT _BOOST_SINGLE_VARIANT)
    _BOOST_SKIPPED("libboost_chrono-mt-a64.dylib" "shared, default on Windows is static, set Boost_USE_STATIC_LIBS=OFF to override")
    return()
  endif()
endif()
...
if(DEFINED Boost_USE_MULTITHREADED AND NOT Boost_USE_MULTITHREADED)
  _BOOST_SKIPPED("libboost_chrono-mt-a64.dylib" "multithreaded, Boost_USE_MULTITHREADED=${Boost_USE_MULTITHREADED}")
  return()
endif()
...
if(Boost_VERBOSE OR Boost_DEBUG)
  message(STATUS "  [x] libboost_chrono-mt-a64.dylib")
endif()
...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::chrono already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/libboost_chrono-mt-a64.dylib'")
endif()

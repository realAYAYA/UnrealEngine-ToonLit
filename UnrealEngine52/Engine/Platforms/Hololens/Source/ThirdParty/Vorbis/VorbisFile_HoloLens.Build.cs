...
namespace UnrealBuildTool.Rules
{
	public class VorbisFile_HoloLens : VorbisFile
	{
		public VorbisFile_HoloLens(ReadOnlyTargetRules Target) : base(Target)
		{
			...
			{
				LibDir = System.String.Format("{0}/{1}/VS{2}/{3}/", VorbisFileLibPath, PlatformSubpath, Target.WindowsPlatform.GetVisualStudioCompilerVersionName(), Target.Architecture.WindowsName);

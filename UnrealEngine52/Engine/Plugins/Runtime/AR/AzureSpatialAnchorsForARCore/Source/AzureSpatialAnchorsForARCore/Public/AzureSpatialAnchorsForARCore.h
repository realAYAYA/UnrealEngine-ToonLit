...
class FAzureSpatialAnchorsForARCore : public FAzureSpatialAnchorsBase, public IModuleInterface
{
public:
	/* IModuleInterface */
...
private:
	...
	TSharedPtr<FAzureSpatialAnchorsAndroidInterop, ESPMode::ThreadSafe> AndroidInterop;
};

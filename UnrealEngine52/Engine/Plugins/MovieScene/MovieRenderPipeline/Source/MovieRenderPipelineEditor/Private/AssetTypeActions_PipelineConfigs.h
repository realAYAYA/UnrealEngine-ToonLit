...
class FAssetTypeActions_PipelinePrimaryConfig : public FAssetTypeActions_Base
{
public:
	// IAssetTypeActions Implementation
	virtual FText GetName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_PipelinePrimaryConfig", "Movie Pipeline Primary Config"); }
	virtual FColor GetTypeColor() const override { return FColor(78, 40, 165); }
	virtual UClass* GetSupportedClass() const override { return UMoviePipelinePrimaryConfig::StaticClass(); }

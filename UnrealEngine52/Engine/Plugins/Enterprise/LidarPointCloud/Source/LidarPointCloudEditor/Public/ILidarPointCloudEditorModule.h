...
public:
	...
	*/
	static inline ILidarPointCloudEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked<ILidarPointCloudEditorModule>("LidarPointCloudEditor");
	}
	...
	*/
	...
	{
		return FModuleManager::Get().IsModuleLoaded("LidarPointCloudEditor");
	}
};

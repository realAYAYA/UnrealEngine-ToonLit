...
namespace UE::NNERuntimeRDG::Private::Hlsl
{
	...
	bool ValidateConvTransposeOperator(const NNECore::FAttributeMap& AttributeMap, TConstArrayView<ENNETensorDataType> InputTypes, TConstArrayView<NNECore::FSymbolicTensorShape> InputShapes)
	{
		bool bIsValid = true;

...
public:
	...
	void InitEditor(const EToolkitMode::Type InMode, const TSharedPtr<IToolkitHost>& InInitToolkitHost, UAnimNextInterfaceGraph* InAnimNextInterfaceGraph);
...
private:
	...
	UAnimNextInterfaceGraph* AnimNextInterfaceGraph = nullptr;

	// Cached editor data ptr
	UAnimNextInterfaceGraph_EditorData* AnimNextInterfaceGraph_EditorData = nullptr;
